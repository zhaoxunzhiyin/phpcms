...
function template($module = 'content', $template = 'index', $style = '') {
	...
	if(file_exists(TPLPATH.$style.DIRECTORY_SEPARATOR.$module.DIRECTORY_SEPARATOR.$template.'.html')) {
		...
		$compiledtplfile = CACHE_PATH.'caches_template'.DIRECTORY_SEPARATOR.'default/'.(pc_base::load_sys_class('service')->is_mobile() ? 'mobile' : 'pc').DIRECTORY_SEPARATOR.$module.DIRECTORY_SEPARATOR.$template.'.php';
		if(!file_exists($compiledtplfile) || (file_exists(TPLPATH.'default/'.(pc_base::load_sys_class('service')->is_mobile() ? 'mobile' : 'pc').DIRECTORY_SEPARATOR.$module.DIRECTORY_SEPARATOR.$template.'.html') && filemtime(TPLPATH.'default/'.(pc_base::load_sys_class('service')->is_mobile() ? 'mobile' : 'pc').DIRECTORY_SEPARATOR.$module.DIRECTORY_SEPARATOR.$template.'.html') > filemtime($compiledtplfile))) {
			$template_cache->template_compile($module, $template, 'default/'.(pc_base::load_sys_class('service')->is_mobile() ? 'mobile' : 'pc'));
		} elseif (!file_exists(TPLPATH.'default/'.(pc_base::load_sys_class('service')->is_mobile() ? 'mobile' : 'pc').DIRECTORY_SEPARATOR.$module.DIRECTORY_SEPARATOR.$template.'.html')) {
			if (IS_DEV) {
