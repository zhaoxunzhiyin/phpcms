...
class baiduapi {
    ...
    // 从url获取json数据
    static function _https_json_data($url, $param = array(), $is_gbk = 0) {
    ...
    static function _access_token() {
        ...
        $url = 'https://aip.baidubce.com/oauth/2.0/token?grant_type=client_credentials&client_id='.pc_base::load_config('system', 'baidu_skey').'&client_secret='.pc_base::load_config('system', 'baidu_arcretkey').'&';
