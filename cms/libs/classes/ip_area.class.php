...
class ip_area {
    ...
    private $file = PC_PATH.DIRECTORY_SEPARATOR.'libs'.DIRECTORY_SEPARATOR.'data'.DIRECTORY_SEPARATOR.'ipdata'.DIRECTORY_SEPARATOR.'qqwry.dat';
    private $address;
    ...
    public function address($ip) {
        ...
        $rs = pc_base::load_sys_class('hooks')::trigger_callback('ip_address', $ip);
    ...
    public function city($ip) {
        ...
        $rs = pc_base::load_sys_class('hooks')::trigger_callback('ip_city', $ip);
        if ($rs && isset($rs['code']) && $rs['code'] && $rs['msg']) {
            return $rs['msg'];
        }
        $this->set($ip);
    ...
    public function province($ip) {
        ...
        $rs = pc_base::load_sys_class('hooks')::trigger_callback('ip_province', $ip);
        if ($rs && isset($rs['code']) && $rs['code'] && $rs['msg']) {
            return $rs['msg'];
        }
        $this->set($ip);
