...
class phpanalysis {
    ...
    {
        $this->addonDicFile = PC_PATH.'libs'.DIRECTORY_SEPARATOR.'data'.DIRECTORY_SEPARATOR.'dict'.DIRECTORY_SEPARATOR.$this->addonDicFile;
        $this->mainDicFile  = PC_PATH.'libs'.DIRECTORY_SEPARATOR.'data'.DIRECTORY_SEPARATOR.'dict'.DIRECTORY_SEPARATOR.$this->mainDicFile;
