...
class index {
	private $input,$cache,$db,$_userid,$_username,$_groupid,$siteid,$category,$category_priv_db,$category_setting,$sitemodel,$form_cache,$page_db,$url,$category_db,$hits_db;
