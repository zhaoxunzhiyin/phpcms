...
<fieldset>
	...
	<table width="100%" class="table_form">
		<tr>
			...
			<td><label><input type="text" name="info[name]" class="input-text" id="name" size="30" onblur="topinyin('tablename','name','?m=member&c=member_model&a=public_ajax_pinyin');"></label></td>
		</tr>
		<tr>
