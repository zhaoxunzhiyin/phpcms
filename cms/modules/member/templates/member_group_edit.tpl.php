...
<fieldset>
	...
	<table width="100%" class="table_form">
		...
		<tr>
			...
			<td>
			<input type="text" name="info[point]" class="input-text" id="point" value="<?php echo $groupinfo['point']?>" size="6"></td>
		</tr>
		<tr>
			<td><?php echo L('member_group_starnum')?></td> 
			<td><input type="text" name="info[starnum]" class="input-text" id="starnum" value="<?php echo $groupinfo['starnum']?>"  size="6"></td>
		</tr>
	</table>
</fieldset>
<div class="bk15"></div>
<fieldset>
	...
	<table width="100%" class="table_form">
		...
		<tr>
			...
			<td><input type="text" name="info[allowpostnum]" class="input-text" id="allowpostnum" size="8" value="<?php echo $groupinfo['allowpostnum']?>">
