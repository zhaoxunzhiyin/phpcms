...
<div class="subnav">
    ...
    <div class="content-menu btn-group dropdown-btn-group"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true"><i class="fa fa-th-large"></i> 菜单 <i class="fa fa-angle-down"></i></a>
        <ul class="dropdown-menu">
            ...
            <li><a class="on" href="<?php echo dr_now_url();?>"><i class="fa fa-plus"></i> <?php echo L('member_modelfield_add');?></a></li>
        </ul>
    </div>
    <?php } else {?>
    <div class="content-menu ib-a">
        <a href="?m=member&c=member_modelfield&a=manage&modelid=<?php echo $modelid?>&menuid=<?php echo $this->input->get('menuid')?>"><i class="fa fa-code"></i> <?php echo L('member_modelfield_manage');?></a><i class="fa fa-circle"></i>
        <a class="on" href="<?php echo dr_now_url();?>"><i class="fa fa-plus"></i> <?php echo L('member_modelfield_add');?></a>
    </div>
    <?php }?>
</div>
...
<input name="info[modelid]" type="hidden" value="<?php echo $modelid;?>">
    ...
    <div class="portlet-body form myfooter">
        <div class="form-actions text-center">
            <button type="button" onclick="dr_ajax_submit('?m=member&c=member_modelfield&a=add&page='+$('#dr_page').val(), 'myform', '2000')" class="btn green"> <i class="fa fa-save"></i> <?php echo L('submit')?></button>
        </div>
    </div>
</form>
</div>
