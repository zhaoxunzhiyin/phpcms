...
<div class="subnav">
    ...
    <div class="content-menu btn-group dropdown-btn-group"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true"><i class="fa fa-th-large"></i> 菜单 <i class="fa fa-angle-down"></i></a>
        <ul class="dropdown-menu">
            <li><a href="?m=member&c=member_modelfield&a=manage&modelid=<?php echo $modelid?>&menuid=<?php echo $this->input->get('menuid')?>"><i class="fa fa-code"></i> <?php echo L('member_modelfield_manage');?></a></li>
            <div class="dropdown-line"></div>
            <li><a href="?m=member&c=member_modelfield&a=add&modelid=<?php echo $modelid?>&menuid=<?php echo $this->input->get('menuid')?>"><i class="fa fa-plus"></i> <?php echo L('member_modelfield_add');?></a></li>
            <div class="dropdown-line"></div>
            <li><a class="on" href="<?php echo dr_now_url();?>"><i class="fa fa-edit"></i> <?php echo L('member_modelfield_edit');?></a>
        </ul>
    </div>
    <?php } else {?>
    <div class="content-menu ib-a">
        <a href="?m=member&c=member_modelfield&a=manage&modelid=<?php echo $modelid?>&menuid=<?php echo $this->input->get('menuid')?>"><i class="fa fa-plus"></i> <?php echo L('member_modelfield_manage');?></a><i class="fa fa-circle"></i>
        <a href="?m=member&c=member_modelfield&a=add&modelid=<?php echo $modelid?>&menuid=<?php echo $this->input->get('menuid')?>"><i class="fa fa-code"></i> <?php echo L('member_modelfield_add');?></a><i class="fa fa-circle"></i>
        <a href="<?php echo dr_now_url();?>" class="on"> <i class="fa fa-edit"></i> <?php echo L('member_modelfield_edit');?></a>
    </div>
    <?php }?>
</div>
...
<input name="oldfield" type="hidden" value="<?php echo $field?>">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane<?php if ($page==3) {?> active<?php }?>" id="tab_3">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label"><?php echo L('search_condition')?></label>
                            <div class="col-md-9">
                                <div class="mt-radio-inline">
                                    <label class="mt-radio mt-radio-outline"><input type="radio" name="info[issearch]" value="1" id="field_allow_search1" <?php if($issearch) echo 'checked';?>> <?php echo L('yes');?> <span></span></label>
                                    <label class="mt-radio mt-radio-outline"><input type="radio" name="info[issearch]" value="0" id="field_allow_search0" <?php if(!$issearch) echo 'checked';?>> <?php echo L('no');?> <span></span></label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <div class="portlet-body form myfooter">
        <div class="form-actions text-center">
            <button type="button" onclick="dr_ajax_submit('?m=member&c=member_modelfield&a=edit&page='+$('#dr_page').val(), 'myform', '2000')" class="btn green"> <i class="fa fa-save"></i> <?php echo L('submit')?></button>
        </div>
    </div>
</form>
</div>
