...
?>
    <tr>
        ...
        <td align="center"><input type="text" name="sort[<?php echo $v['groupid']?>]" class="displayorder form-control input-sm input-inline input-mini" value="<?php echo $v['sort']?>"></th>
