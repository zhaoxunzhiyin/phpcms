...
<fieldset>
	...
	<table width="100%" class="table_form">
		...
		<tr>
			...
			<td>
			<input type="text" name="info[point]" class="input-text" id="point" value="0" size="6"></td>
		</tr>
		<tr>
			<td><?php echo L('member_group_starnum')?></td> 
			<td><input type="text" name="info[starnum]" class="input-text" id="starnum" value="0" size="6"></td>
		</tr>
	</table>
</fieldset>
<div class="bk15"></div>
<fieldset>
	...
	<table width="100%" class="table_form">
		...
		<tr>
			...
			<td><input type="text" name="info[allowpostnum]" class="input-text" id="allowpostnum" size="8">
