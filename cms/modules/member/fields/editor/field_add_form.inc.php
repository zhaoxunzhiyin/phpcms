...
<table cellpadding="2" cellspacing="1" width="98%">
	...
	<tr<?php if (!pc_base::load_config('system', 'editor')) {?> style="display: none;"<?php }?>> 
      <td>编辑器颜色：</td>
      <td><input type="text" id="style_color" name="setting[color]" value="" size="6" autocomplete="off" class="input-text" style="height: 30px;"><script type="text/javascript">
      $(function(){
	...
	<tr> 
      <td>是否允许上传附件：</td>
      <td><div class="mt-radio-inline">
          <label class="mt-radio mt-radio-outline"><input type="radio" name="setting[allowupload]" value="1"> 是 <span></span></label>
          <label class="mt-radio mt-radio-outline"><input type="radio" name="setting[allowupload]" value="0" checked> 否 <span></span></label>
        </div></td>
    </tr>
	<tr> 
      <td>是否保存远程图片：</td>
