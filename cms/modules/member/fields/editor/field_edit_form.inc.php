...
<table cellpadding="2" cellspacing="1" width="98%">
	...
	<tr>
      <td>是否允许上传附件：</td>
      <td><div class="mt-radio-inline">
          <label class="mt-radio mt-radio-outline"><input type="radio" name="setting[allowupload]" value="1" <?php if($setting['allowupload']==1) echo 'checked';?>> 是 <span></span></label>
          <label class="mt-radio mt-radio-outline"><input type="radio" name="setting[allowupload]" value="0" <?php if($setting['allowupload']==0) echo 'checked';?>> 否 <span></span></label>
        </div></td>
    </tr>
	<tr> 
      <td>是否保存远程图片：</td>
