	function editor($field, $value, $fieldinfo) {
		...
		return "<div id='{$field}_tip'></div>".'<textarea name="info['.$field.']" id="'.$field.'" boxid="'.$field.'">'.$value.'</textarea>'.form::editor($field,$toolbar,$toolvalue,'member','',$color,$allowupload,1,'',$height,'',$autofloat,$autoheight,$theme,$watermark,$attachment,$image_reduce,$div2p,$enablesaveimage);
	}
