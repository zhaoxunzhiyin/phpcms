	function editor($field, $value, $fieldinfo) {
		...
		return "<div id='{$field}_tip'></div>".'<textarea class="dr_ueditor dr_ueditor_'.$field.'" name="info['.$field.']" id="'.$field.'">'.$value.'</textarea>'.form::editor($field,$toolbar,'member','',$color,$allowupload,1,'',$height,0,$upload_number,$this->modelid,$toolvalue,$autofloat,$autoheight,$theme,$language,$watermark,$attachment,$image_reduce,$chunk,$div2p,$anchorduiqi,$imageduiqi,$videoduiqi,$musicduiqi,$enter,$enablesaveimage,$width,$upload_maxsize);
	}
