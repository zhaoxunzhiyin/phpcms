...
</span><label class="mt-checkbox mt-checkbox-outline"><input type="checkbox" name="id[]" value="<?php echo $v['id']?>"><?php echo direction($v['direction'])?> <?php echo $v['username']?> (<?php echo $v['ip']?>) <?php echo L('chez')?> <?php echo format::date($v['creat_at'], 1)?> <?php echo L('release')?> <?php echo L('support')?>：<?php echo $v['support']?><span></span></label></h5>
    <div class="content">
