...
<form name="myform" id="myform" action="?m=message&c=message&a=delete_inbox" method="post" onsubmit="checkuid();return false;">
...
<table width="100%" cellspacing="0">
    <thead>
        <tr>
            ...
            <th width="120" align="center"><?php echo L('message_sender')?></th>
