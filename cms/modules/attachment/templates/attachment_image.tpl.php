...
<script src="<?php echo JS_PATH;?>cropper/js/cropper.js" type="text/javascript"></script>
            ...
            <div class="col-md-3">
                ...
                <div class="docs-data">
                    ...
                    <div class="margin-top-10">
                        <button type="button" class="btn btn-xs btn-warning" id="toggleBrush"><?php echo L('开启画笔');?></button>
                        <button type="button" class="btn btn-xs btn-default" id="clearBrush"><?php echo L('清空笔迹');?></button>
                    </div>
                    <div class="input-group input-group-sm margin-top-10">
                        <label class="input-group-addon" for="brushSize"><?php echo L('笔刷大小');?></label>
