...
<div class="col-md-2 col-sm-2 col-xs-6 upload-item">
    <div class="files_row tooltips" data-original-title="<?php echo $_v['filename']?>&nbsp;&nbsp;<?php echo $_v['size']?>">
        ...
        <a><img class="rs-load" width="<?php echo $_v['width']?>" id="<?php echo $_v['aid']?>" path="<?php echo $_v['src']?>" src="<?php echo JS_PATH;?>layer/theme/default/loading-1.gif" rs-src="<?php echo $_v['fileimg']?>" filename="<?php echo $_v['filename']?>" size="<?php echo $_v['size']?>"></a>
        <i class="size"><?php echo $_v['size']?></i>
        <i class="name"><?php echo $_v['filename']?></i>
        <a href="javascript:;" class="upload-del" onclick="dr_file_delete('?m=attachment&c=manage&a=delete', this, <?php echo $_v['aid'];?>);return false;"><i class="fa fa-trash"></i></a>
    </div>
</div>
<?php }}?>
</div>
