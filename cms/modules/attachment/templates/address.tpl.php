...
<table width="100%"  class="table_form">
  <tr>
    ...
    <td class="y-bg"><input type="text" class="input-text" name="old_attachment_path" id="old_attachment_path" size="40" value="<?php echo SYS_UPLOAD_URL;?>" /> <?php echo L('old_attachment_address_msg')?></td>
  </tr>
  <tr>
   ...
   <tr>
    <th></th>
    <td class="y-bg"><input type="button" value="<?php echo L('submit')?>" class="button" onclick="Dialog.confirm('<?php echo L('form_submit_confirm')?>',function(){$('#myform').submit();});"></td>
  </tr>
</table>
</form>
</div>
