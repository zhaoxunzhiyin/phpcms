        ...
        <form class="form-horizontal" role="form" id="myform">
            ...
            <div class="row list-footer table-checkable">
                <div class="col-md-5 list-select">
                    ...
                    <label><button type="button" onclick="ajax_option('?m=attachment&c=manage&a=public_delete_all', '<?php echo L('del_confirm')?>', 1)" class="btn red btn-sm"> <i class="fa fa-trash"></i> <?php echo L('delete');?></button></label>
                    <label>
...
function showthumb(id, name) {
    ...
    var diag = new Dialog({
        ...
        url:'<?php echo SELF;?>?m=attachment&c=manage&a=public_showthumbs&aid='+id+'&pc_hash='+pc_hash,
        width:width,
        height:height,
        modal:true
    });
