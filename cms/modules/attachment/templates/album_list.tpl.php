...
<div class="col-md-2 col-sm-2 col-xs-6 upload-item">
    <div class="files_row tooltips" data-original-title="<?php echo $r['filename']?>&nbsp;&nbsp;<?php echo format_file_size($r['filesize'])?>"<?php if (is_mobile()) {?> id="attachment_<?php echo $r['aid']?>" onclick="javascript:att_cancel(this)"<?php }?>>
        ...
        <a href="javascript:preview('<?php echo $r['src']?>');"><img class="rs-load" src="<?php echo JS_PATH;?>layer/theme/default/loading-1.gif" rs-src="<?php echo $r['src']?>" id="<?php echo $r['aid']?>" path="<?php echo dr_get_file_url($r)?>" size="<?php echo format_file_size($r['filesize'])?>" filename="<?php echo $r['filename']?>"/></a>
