    ...
    <div class="portlet-title tabbable-line">
        <ul class="nav nav-tabs" style="float:left;">
            <li<?php if ($page==0) {?> class="active"<?php }?>>
                <a data-toggle="tab_0" onclick="h5upload_ready();$('#dr_page').val('0')"<?php if (is_mobile()) {echo ' onmouseover="layer.tips(\''.L('upload_attachment').'\',this,{tips: [1, \'#fff\']});" onmouseout="layer.closeAll();"';}?>> <i class="fa fa-upload"></i> <?php if (!is_mobile()) {echo L('upload_attachment');}?> </a>
            </li>
            <li<?php if ($page==1) {?> class="active"<?php }?>>
                <a data-toggle="tab_1" onclick="h5upload_ready();$('#dr_page').val('1')"<?php if (is_mobile()) {echo ' onmouseover="layer.tips(\''.L('net_file').'\',this,{tips: [1, \'#fff\']});" onmouseout="layer.closeAll();"';}?>> <i class="fa fa-download"></i> <?php if (!is_mobile()) {echo L('net_file');}?> </a>
            </li>
            <?php if($allowupload && $this->isadmin && param::get_session('userid')) {?>
            <li<?php if ($page==2) {?> class="active"<?php }?>>
                <a data-toggle="tab_2" onclick="h5upload_ready();$('#dr_page').val('2');"<?php if (is_mobile()) {echo ' onmouseover="layer.tips(\''.L('gallery').'\',this,{tips: [1, \'#fff\']});" onmouseout="layer.closeAll();"';}?>> <i class="fa fa-photo"></i> <?php if (!is_mobile()) {echo L('gallery');}?> </a>
            </li>
            <li<?php if ($page==3) {?> class="active"<?php }?>>
                <a data-toggle="tab_3" onclick="h5upload_ready();$('#dr_page').val('3');"<?php if (is_mobile()) {echo ' onmouseover="layer.tips(\''.L('directory_browse').'\',this,{tips: [1, \'#fff\']});" onmouseout="layer.closeAll();"';}?>> <i class="fa fa-folder-open"></i> <?php if (!is_mobile()) {echo L('directory_browse');}?> </a>
            </li>
            <?php }?>
            <?php if($att_not_used!='') {?>
            <li<?php if ($page==4) {?> class="active"<?php }?>>
                <a data-toggle="tab_4" onclick="h5upload_ready();$('#dr_page').val('4');"<?php if (is_mobile()) {echo ' onmouseover="layer.tips(\''.L('att_not_used').'\',this,{tips: [1, \'#fff\']});" onmouseout="layer.closeAll();"';}?>> <i class="fa fa-ban"></i> <?php if (!is_mobile()) {echo L('att_not_used');}?> </a>
            </li>
            <?php }?>
        </ul>
    </div>
