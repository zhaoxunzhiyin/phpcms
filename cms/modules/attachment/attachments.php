...
class attachments {
	private $input,$cache,$att_db,$upload,$imgext,$userid,$rid,$grouplist,$isadmin,$groupid,$sitedb,$cookie_att;
	function __construct() {
		...
		$this->isadmin = param::get_session('roleid') ? 1 : 0;
	...
	public function upload() {
		// 验证上传权限
		if($this->_check_upload_auth(1)) return false;
	...
	public function album_load() {
		...
		$infos = $this->att_db->listinfo($where, 'uploadtime desc', $page, SYS_ATTACHMENT_PAGESIZE);
