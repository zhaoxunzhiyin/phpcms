    ...
    <div class="portlet-title tabbable-line">
        <ul class="nav nav-tabs" style="float:left;">
            ...
            <li<?php if ($page==3) {?> class="active"<?php }?>>
                <a data-toggle="tab_3"<?php if (is_mobile()) {echo ' onmouseover="layer.tips(\''.L('数据表分区').'\',this,{tips: [1, \'#fff\']});" onmouseout="layer.closeAll();"';}?>> <i class="fa fa-table"></i> <?php if (is_pc()) {echo L('数据表分区');}?> </a>
            </li>
            <?php }?>
        </ul>
    </div>
