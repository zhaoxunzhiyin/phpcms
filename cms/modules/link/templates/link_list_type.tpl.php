...
<form name="myform" id="myform" action="?m=link&c=link&a=delete_type" method="post" onsubmit="checkuid();return false;">
...
?>
    <tr>
        ...
        <td align="center"><input name='listorders[<?php echo $info['typeid']?>]' type='text' value='<?php echo $info['listorder']?>' class="displayorder form-control input-sm input-inline input-mini"></td> 
        ...
        <td align="center"> <?php echo $info['typeid'];?></td>
         <td align="center"><a class="btn btn-xs green" href="javascript:void(0);"
            ...
            onClick="Dialog.confirm('<?php echo L('confirm', array('message' => new_addslashes($info['name'])))?>',function(){redirect('?m=link&c=link&a=delete_type&typeid=<?php echo $info['typeid']?>&pc_hash='+pc_hash);});"> <i class="fa fa-trash"></i> <?php echo L('delete')?></a>
        </td
    </tr>
    <?php
    }
