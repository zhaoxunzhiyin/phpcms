...
<fieldset id="history" style="display:none">
	...
	<div class="table-list">
        ...
        <td><a href="?m=block&c=block_admin&a=history_restore&id=<?php echo $val['id']?>"><?php echo L('restore')?></a> <a href="###" onclick="Dialog.confirm('<?php echo L('are_you_sure_you_want_to_delete')?>',function(){redirect('?m=block&c=block_admin&a=history_del&id=<?php echo $val['id']?>&pc_hash='+pc_hash);});"><?php echo L('delete')?></a></td>
        </tr>
        <?php endforeach;?>
</tbody>
</table>
