...
<tbody>
	...
	<tr>
		...
		<td><div class="mt-radio-inline">
          <label class="mt-radio mt-radio-outline"><input type="radio" name="setting[enabletime]" value="1" <?php if ($data['setting']['enabletime']) {?>checked<?php }?>> <?php echo L('enable')?> <span></span></label>
          <label class="mt-radio mt-radio-outline"><input type="radio" name="setting[enabletime]" value="0" <?php if ($data['setting']['enabletime']==0) {?>checked<?php }?>> <?php echo L('unenable')?> <span></span></label>
        </div></td>
	</tr>
	...
	<tr>
		...
		<td><div class="mt-radio-inline">
          <label class="mt-radio mt-radio-outline"><input name="setting[sendmail]" type="radio" value="1" <?php if ($data['setting']['sendmail']) {?>checked<?php }?>>&nbsp;<?php echo L('yes')?> <span></span></label>
          <label class="mt-radio mt-radio-outline"><input name="setting[sendmail]" type="radio" value="0" <?php if ($data['setting']['sendmail']==0) {?>checked<?php }?>>&nbsp;<?php echo L('no')?> <span></span></label>
        </div></td>
	</tr>
	...
	<tr>
		...
		<td><div class="mt-radio-inline">
          <label class="mt-radio mt-radio-outline"><input type='radio' name='setting[allowmultisubmit]' value='1' <?php if($data['setting']['allowmultisubmit'] == 1) {?>checked<?php }?>> <?php echo L('yes')?> <span></span></label>
          <label class="mt-radio mt-radio-outline"><input type='radio' name='setting[allowmultisubmit]' value='0' <?php if($data['setting']['allowmultisubmit'] == 0) {?>checked<?php }?>> <?php echo L('no')?> <span></span></label>
        </div>
	  </td>
	</tr>
	<tr>
		...
		<td><div class="mt-radio-inline">
          <label class="mt-radio mt-radio-outline"><input type='radio' name='setting[allowunreg]' value='1' <?php if($data['setting']['allowunreg'] == 1) {?>checked<?php }?>> <?php echo L('yes')?> <span></span></label>
          <label class="mt-radio mt-radio-outline"><input type='radio' name='setting[allowunreg]' value='0' <?php if($data['setting']['allowunreg'] == 0) {?>checked<?php }?>> <?php echo L('no')?> <span></span></label>
        </div></td>
	</tr>
	<tr>
