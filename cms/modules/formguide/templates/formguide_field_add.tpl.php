...
<input name="info[modelid]" type="hidden" value="<?php echo $formid?>">
                ...
                <div class="tab-pane<?php if ($page==0) {?> active<?php }?>" id="tab_0">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group" id="dr_row_name">
                            ...
                            <div class="col-md-9">
                                <label><input class="form-control" type="text" name="info[name]" value="" id="dr_name" onblur="topinyin('dr_field','dr_name','?m=formguide&c=formguide_field&a=public_ajax_pinyin');"></label>
    ...
    <div class="portlet-body form myfooter">
        <div class="form-actions text-center">
            <button type="button" onclick="dr_ajax_submit('?m=formguide&c=formguide_field&a=add&page='+$('#dr_page').val(), 'myform', '2000')" class="btn green"> <i class="fa fa-save"></i> <?php echo L('submit')?></button>
        </div>
    </div>
</form>
</div>
