...
<div class="table-list">
    <table width="100%" cellspacing="0">
        <thead>
            ...
            <th width="80" style="text-align:center;"><?php echo L('状态')?></th>
...
?>
    ...
    <a class="btn btn-xs dark" href="javascript:dr_iframe_show('<?php echo L('field');?>','?m=formguide&c=formguide_field&a=init&formid=<?php echo $form['modelid']?>&menuid=<?php echo $this->input->get('menuid')?>&is_menu=1', '80%', '90%');"><?php echo L('field')?></a>
