...
$parentid = $menu_db->insert(array('name'=>'vote', 'parentid'=>'29', 'm'=>'vote', 'c'=>'vote', 'a'=>'init', 'data'=>'', 'icon'=>'fa fa-pie-chart', 'listorder'=>0, 'display'=>'1'), true);
$menu_db->insert(array('name'=>'add_vote', 'parentid'=>$parentid, 'm'=>'vote', 'c'=>'vote', 'a'=>'add', 'data'=>'', 'icon'=>'fa fa-plus', 'listorder'=>0, 'display'=>'0'));
...
$menu_db->insert(array('name'=>'create_js', 'parentid'=>$parentid, 'm'=>'vote', 'c'=>'vote', 'a'=>'create_js', 'data'=>'', 'icon'=>'fa fa-refresh', 'listorder'=>0, 'display'=>'1'));
