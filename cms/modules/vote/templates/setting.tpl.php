...
<table width="100%" cellpadding="0" cellspacing="1" class="table_form">
	...
	<tr>
		...
		<td><div class="mt-radio-inline">
          <label class="mt-radio mt-radio-outline"><input type="radio" name="setting[allowguest]" value="1" <?php if($allowguest == 1) {?>checked<?php }?>> <?php echo L('yes')?> <span></span></label>
          <label class="mt-radio mt-radio-outline"><input type="radio" name="setting[allowguest]" value="0" <?php if($allowguest == 0) {?>checked<?php }?>> <?php echo L('yes')?> <span></span></label>
        </div></td>
	</tr>
	<tr>
		<th><?php echo L('default_enabled')?>：</th>
		<td><div class="mt-radio-inline">
          <label class="mt-radio mt-radio-outline"><input type="radio" name="setting[enabled]" value="1" <?php if($enabled == 1) {?>checked<?php }?>> <?php echo L('yes')?> <span></span></label>
          <label class="mt-radio mt-radio-outline"><input type="radio" name="setting[enabled]" value="0" <?php if($enabled == 0) {?>checked<?php }?>> <?php echo L('yes')?> <span></span></label>
        </div></td>
	</tr>
	<tr>
