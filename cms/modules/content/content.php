...
class content extends admin {
	private $input,$cache,$cache_api,$db,$menu_db,$field_db,$linkage_db,$priv_db,$sitemodel,$form_cache,$page_db,$fields,$hits_db,$queue,$content_check_db,$position_data_db,$search_db,$comment,$url,$model,$admin_db,$sitemodel_db,$att_db,$sitedb,$upload;
	...
	public function public_crop() {
		...
		$this->userid = param::get_session('userid') ? param::get_session('userid') : (param::get_cookie('userid') ? param::get_cookie('userid') : param::get_cookie('_userid'));
		if (IS_POST) {
