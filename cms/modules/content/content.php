...
class content extends admin {
	private $input,$cache,$cache_api,$db,$menu_db,$field_db,$priv_db,$sitemodel,$form_cache,$page_db,$fields,$hits_db,$queue,$content_check_db,$position_data_db,$search_db,$comment,$url,$model,$admin_db,$sitemodel_db,$att_db,$sitedb,$upload;
	...
	public function public_preview() {
		...
		$CATEGORYS = getcache('cache', 'module/category-'.$this->siteid.'-data');
