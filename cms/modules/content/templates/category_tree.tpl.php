...
<?php } else { ?>
<ul class="filetree  treeview"><li class="collapsable"><div class="hitarea collapsable-hitarea"></div><span><img src="<?php echo IMG_PATH.'icon/home.png';?>" width="15" height="14">&nbsp;<a href='?m=content&c=content&a=initall&menuid=822' target='right'><?php echo L('allcontent');?></a></span></li></ul>
