...
<fieldset>
  ...
  <tr>
    ...
    <td class="y-bg"><label><input type="text" class="input-text" name="info[modelname]" id="name" size="30" onblur="topinyin('tablename','name','?m=content&c=sitemodel&a=public_ajax_pinyin');" /></label></td>
  </tr>
  <tr>
