...
<td align="center"><a class="btn btn-xs green" href="javascript:edit('<?php echo $r['typeid']?>','<?php echo trim(new_addslashes($r['name']))?>')"><?php echo L('edit');?></a> <a class="btn btn-xs red" href="javascript:;" onclick="data_delete(this,'<?php echo $r['typeid']?>','<?php echo L('confirm', array('message' => new_addslashes($r['name'])))?>')"><?php echo L('delete')?></a> </td>
</tr>
<?php }} ?>
	</tbody>
    </table>
