...
?>
            ...
            <li><a href='?m=content&c=content&a=public_checkall&menuid=<?php echo $this->input->get('menuid');?>&status=<?php echo $j;?>' class="<?php if($status==$j) echo 'on';?>"><i class="fa fa-<?php if($j) {?>sort-numeric-asc<?php } else {?>sign-out<?php }?>"></i> <?php echo L('workflow_'.$j);?></a></li>
<?php }?>
        </ul>
    </div>
    <?php } else {?>
...
for ($j=0;$j<5;$j++) {
?>
<i class="fa fa-circle"></i><a href='?m=content&c=content&a=public_checkall&menuid=<?php echo $this->input->get('menuid');?>&status=<?php echo $j;?>' class="<?php if($status==$j) echo 'on';?>"><i class="fa fa-<?php if($j) {?>sort-numeric-asc<?php } else {?>sign-out<?php }?>"></i> <?php echo L('workflow_'.$j);?></a>
<?php }?>
</div>
    <?php }?>
</div>
