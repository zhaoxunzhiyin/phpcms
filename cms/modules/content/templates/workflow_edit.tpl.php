  ...
  <tr>
    ...
    <td class="y-bg">
      <div class="mt-radio-inline">
        <label class="mt-radio mt-radio-outline"><input type="radio" name="info[flag]" value="1" <?php if($flag) echo 'checked';?>> 是 <span></span></label>
        <label class="mt-radio mt-radio-outline"><input type="radio" name="info[flag]" value="0" <?php if(!$flag) echo 'checked';?>> 否 <span></span></label>
      </div>
    </td>
  </tr>
</table>
