...
<fieldset>
  ...
  <tr>
    ...
    <td class="y-bg"><div class="mt-radio-inline">
        <label class="mt-radio mt-radio-outline"><input type="radio" name="setting[updatetime_select]" value="0"<?php if (empty($updatetime_select)) echo ' checked';?> /> <?php echo L('check_not_default')?> <span></span></label>
        <label class="mt-radio mt-radio-outline"><input type="radio" name="setting[updatetime_select]" value="1"<?php if ($updatetime_select) echo ' checked';?> /> <?php echo L('check_default')?> <span></span></label>
    </div></td>
  </tr>
</table>
</fieldset>
...
<div class="bk15"></div>
<fieldset>
	<legend><label class="mt-checkbox mt-checkbox-outline"><input type="checkbox"<?php if($admin_list_template){?> checked<?php }?> id="other" value="1" name="other"> <?php echo L('other_template_setting')?> <span></span></label></legend>
