    ...
    <div class="portlet-title tabbable-line">
        <ul class="nav nav-tabs" style="float:left;">
            ...
            <li<?php if ($page==4) {?> class="active"<?php }?>>
                <a data-toggle="tab_4" onclick="$('#dr_page').val('4')"<?php if (is_mobile()) {echo ' onmouseover="layer.tips(\''.L('搜索设置').'\',this,{tips: [1, \'#fff\']});" onmouseout="layer.closeAll();"';}?>> <i class="fa fa-cogs"></i> <?php if (is_pc()) {echo L('搜索设置');}?> </a>
            </li>
            <li<?php if ($page==5) {?> class="active"<?php }?>>
                <a data-toggle="tab_5" onclick="$('#dr_page').val('5')"<?php if (is_mobile()) {echo ' onmouseover="layer.tips(\''.L('搜索限制').'\',this,{tips: [1, \'#fff\']});" onmouseout="layer.closeAll();"';}?>> <i class="fa fa-search"></i> <?php if (is_pc()) {echo L('搜索限制');}?> </a>
            </li>
            <li<?php if ($page==6) {?> class="active"<?php }?>>
                <a data-toggle="tab_6" onclick="$('#dr_page').val('6')"<?php if (is_mobile()) {echo ' onmouseover="layer.tips(\''.L('搜索匹配方式').'\',this,{tips: [1, \'#fff\']});" onmouseout="layer.closeAll();"';}?>> <i class="fa fa-map"></i> <?php if (is_pc()) {echo L('搜索匹配方式');}?> </a>
            </li>
            <li<?php if ($page==7) {?> class="active"<?php }?>>
                <a data-toggle="tab_7" onclick="$('#dr_page').val('7')"<?php if (is_mobile()) {echo ' onmouseover="layer.tips(\''.L('搜索URL结构').'\',this,{tips: [1, \'#fff\']});" onmouseout="layer.closeAll();"';}?>> <i class="fa fa-link"></i> <?php if (is_pc()) {echo L('搜索URL结构');}?> </a>
            </li>
        </ul>
    </div>
        ...
        <div class="tab-content">
            <div class="tab-pane<?php if ($page==0) {?> active<?php }?>" id="tab_0">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label"><?php echo L('解析自定义URL');?></label>
                        <div class="col-md-9">
                            <div class="mt-radio-inline">
                                <label class="mt-radio mt-radio-outline"><input type="radio" name="setting[not_diy_url_route]" value="1"<?php echo ($not_diy_url_route) ? ' checked' : '';?>> <?php echo L('手动解析');?> <span></span></label>
                                <label class="mt-radio mt-radio-outline"><input type="radio" name="setting[not_diy_url_route]" value="0"<?php echo (!$not_diy_url_route) ? ' checked' : '';?>> <?php echo L('自动解析');?> <span></span></label>
                            </div>
                            <span class="help-block"><?php echo L('自动解析不需要配置rewrite.php规则但会产生缓存文件；手动解析需要配置rewrite.php规则，大数据推荐')?></span>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <label><input class="form-control input-large" type="text" name="setting[desc_limit]" value="<?php echo $desc_limit;?>"></label>
            ...
            <div class="tab-pane<?php if ($page==4) {?> active<?php }?>" id="tab_4">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <div class="mt-radio-inline">
                                <label class="mt-radio mt-radio-outline"><input type="radio" name="setting[search][search_param]" value="1"<?php echo ($search['search_param']) ? ' checked' : '';?> /> <?php echo L('open');?> <span></span></label>
                                <label class="mt-radio mt-radio-outline"><input type="radio" name="setting[search][search_param]" value="0"<?php echo (!$search['search_param']) ? ' checked' : '';?> /> <?php echo L('close');?> <span></span></label>
                            </div>
                            <span class="help-block"><?php echo L('默认情况下在搜索参数为空时会显示全部结果');?></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label"><?php echo L('分页数量');?></label>
                        <div class="col-md-9">
                            <label><input class="form-control input-large" type="text" id="pagesize" name="setting[search][pagesize]" value="<?php echo $search['pagesize'];?>" ></label>
                            <span class="help-block"><?php echo L('每页显示多少条内容，默认10');?></span>
                        </div>
                    </div>
            ...
            <div class="tab-pane<?php if ($page==5) {?> active<?php }?>" id="tab_5">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group dr_search">
                        ...
                        <div class="col-md-9">
                            <label><input class="form-control" type="text" name="setting[search][max]" value="<?php echo ($search['max']) ? $search['max'] : 0;?>" ></label>
            ...
            <div class="tab-pane<?php if ($page==6) {?> active<?php }?>" id="tab_6">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <div class="mt-checkbox-inline">
                                <label class="mt-checkbox mt-checkbox-outline"><input type="checkbox" name="search_field[]" value="id"<?php if (dr_in_array('id', (array)explode(',', (string)$search['field']))) {?> checked<?php }?> /> ID<span></span></label>
                                <?php foreach($search_field as $f) {?>
                                <?php if ($f['field']!='catid') {?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <div class="mt-radio-inline">
                                <label class="mt-radio mt-radio-outline"><input type="radio" name="setting[search][is_double_like]" value="1"<?php echo ($search['is_double_like']) ? ' checked' : '';?> /> <?php echo L('AND匹配');?> <span></span></label>
                                <label class="mt-radio mt-radio-outline"><input type="radio" name="setting[search][is_double_like]" value="0"<?php echo (!$search['is_double_like']) ? ' checked' : '';?> /> <?php echo L('OR匹配');?> <span></span></label>
                            </div>
            ...
            <div class="tab-pane<?php if ($page==7) {?> active<?php }?>" id="tab_7">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group dr_search">
                        ...
                        <div class="col-md-9">
                            <?php echo form::urlrule('content','search',0,$search['urlrule'],'name="setting[search][urlrule]"','动态地址');?>
                            <?php $menu_data = $this->menu_db->get_one(array('name' => 'urlrule_manage', 'm' => 'admin', 'c' => 'urlrule', 'a' => 'init'));?>
                            <label><a class="btn btn-sm blue"<?php if (param::get('is_iframe') && !param::get('is_menu')) {?> href="?m=admin&c=urlrule&a=init&menuid=<?php echo $menu_data['id']?>&pc_hash=<?php echo dr_get_csrf_token()?>"<?php }else{?> href="javascript:;" layuimini-content-href="?m=admin&c=urlrule&a=init&menuid=<?php echo $menu_data['id']?>&pc_hash=<?php echo dr_get_csrf_token()?>" data-title="URL规则管理" data-icon="fa fa-link"<?php }?>><i class="fa fa-link"></i> URL规则管理</a></label>
                        </div>
                    </div>
                    <div class="form-group dr_search">
                        <label class="col-md-2 control-label"><?php echo L('搜索参数连接符号');?></label>
                        <div class="col-md-9">
                            <label><input class="form-control" type="text" name="setting[search][param_join]" value="<?php echo ($search['param_join']) ? $search['param_join'] : '-';?>" ></label>
                    ...
                    <div class="form-group dr_search">
                        ...
                        <div class="col-md-9">
                            <div class="mt-radio-inline">
                                <label class="mt-radio mt-radio-outline"><input onclick="$('.param_rule_0').hide();$('.param_rule_1').show()" type="radio" name="setting[search][param_rule]" value="1"<?php echo ($search['param_rule']) ? ' checked' : '';?> /> <?php echo L('固定匹配');?> <span></span></label>
                                <label class="mt-radio mt-radio-outline"><input onclick="$('.param_rule_0').show();$('.param_rule_1').hide()" type="radio" name="setting[search][param_rule]" value="0"<?php echo (!$search['param_rule']) ? ' checked' : '';?> /> <?php echo L('自由组合');?> <span></span></label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group dr_search param_rule_0" style="display: none;">
                        ...
                        <div class="col-md-9">
                            <textarea class="form-control" rows="7" name="setting[search][param_field]"><?php echo ($search['param_field']);?></textarea>
                    ...
                    <div class="form-group dr_search param_rule_1" style="display: none;">
                        ...
                        <div class="col-md-9">
                            <?php $c=0;
                            foreach($search_field as $f1) {?>
                            <label><select name="setting[search][param_join_field][<?php echo $c;?>]" class="form-control">
                                <option value="">-</option>
                                <option value="keyword"<?php if ($search['param_join_field'][$c] == 'keyword') {?> selected<?php }?>><?php echo L('搜索词');?>（keyword）</option>
                                <option value="order"<?php if ($search['param_join_field'][$c] == 'order') {?> selected<?php }?>><?php echo L('排序');?>（order）</option>
                                <option value="page"<?php if ($search['param_join_field'][$c] == 'page') {?> selected<?php }?>><?php echo L('分页');?>（page）</option>
                                <?php foreach($search_field as $f) {?>
                                <option value="<?php echo $f['field'];?>"<?php if ($f['field'] == $search['param_join_field'][$c]) {?> selected<?php }?>><?php echo L($f['name']);?>（<?php echo $f['field'];?>）</option>
                                <?php }?>
                            </select></label>
                            <?php $c++;}?>
                    ...
                    <div class="form-group dr_search param_rule_1" style="display: none;">
                        ...
                        <div class="col-md-9">
                            <label><input class="form-control" type="text" name="setting[search][param_join_default_value]" value="<?php echo ($search['param_join_default_value']) ? $search['param_join_default_value'] : 0;?>" ></label>
                            <span class="help-block"><?php echo L('搜索变量为空时的填充值，例如：0-0-0-搜索词-排序-分页.html');?></span>
                        </div>
                    </div>
                    <script>
                    $('.param_rule_<?php echo intval($search['param_rule']);?>').show();
                    </script>
                    <div class="form-group dr_search">
                        <label class="col-md-2 control-label"><?php echo L('按字段参数值指定模板');?></label>
                        <div class="col-md-9">
                            <label><select name="setting[search][tpl_field]" class="form-control">
                                <option value=""><?php echo L('默认模板');?></option>
                                <option value="keyword"<?php if ($search['tpl_field'] == 'keyword') {?> selected<?php }?>><?php echo L('搜索词');?>（keyword）</option>
                                <option value="order"<?php if ($search['tpl_field'] == 'order') {?> selected<?php }?>><?php echo L('排序');?>（order）</option>
                                <option value="page"<?php if ($search['tpl_field'] == 'page') {?> selected<?php }?>><?php echo L('分页');?>（page）</option>
                                <?php foreach($search_field as $f) {?>
                                <option value="<?php echo $f['field'];?>"<?php if ($f['field'] == $search['tpl_field']) {?> selected<?php }?>><?php echo L($f['name']);?>（<?php echo $f['field'];?>）</option>
                                <?php }?>
                            </select></label>
                            <span class="help-block"><?php echo L('用于按字段参数值显示不同的搜索模板文件，模板命名格式为：/search_字段参数值.html');?></span>
                        </div>
                    </div>
                </div>
