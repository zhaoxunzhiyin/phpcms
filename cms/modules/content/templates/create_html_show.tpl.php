            ...
            <form id="myform_category_show">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <label><button type="button" onclick="iframe_show('批量更新全部内容URL', '?m=content&c=create_html&a=public_show_url&modelid=<?php echo $modelid;?>&'+$('#myform_category_show').serialize())" class="btn default"> <i class="fa fa-link"></i> <?php echo L('批量更新全部内容URL');?> </button></label>
                    </div>
                </div>
            </form>
        </div>
