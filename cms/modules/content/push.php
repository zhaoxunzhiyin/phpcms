...
class push extends admin {
	...
	public function __construct() {
		...
		$module = $this->input->post('module') ? $this->input->post('module') : ($this->input->get('module') ? $this->input->get('module') : 'admin');
	...
	public function init() {
		if (IS_POST) {
			...
			$add_action = $this->input->post('action') ? $this->input->post('action') : ($this->input->get('add_action') ? $this->input->get('add_action') : $this->input->get('action')); 
