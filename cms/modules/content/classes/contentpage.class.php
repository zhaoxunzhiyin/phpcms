...
class contentpage {
	...
	private $html_end_tag = array();
	private $surplus; //剩余字符数
	public $content; //定义返回的字符
	private $data = array(); //内容存储
	 ...
	 */	
	private function separate_text($str = '', $max = 10000){
		$str = clearhtml($str);
	 ...
	 * @return boolen
	 */
	private function separate_content($str = '', $max = 10000, $tag = '', $t = 0, $n = 1, $total = 0) {
		$html = $str;
		$str = clearhtml($str);
