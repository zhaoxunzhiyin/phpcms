<?php defined('IN_CMS') or exit('No permission resources.');?>
    ...
    <div class="form-group">
      ...
      <div class="col-md-9">
            <div class="mt-radio-inline">
          <label class="mt-radio mt-radio-outline"><input type="radio" name="setting[collapse]" value="0" <?php if(!$setting['collapse']) echo 'checked';?>> 开启 <span></span></label>
          <label class="mt-radio mt-radio-outline"><input type="radio" name="setting[collapse]" value="1" <?php if($setting['collapse']) echo 'checked';?>> 关闭 <span></span></label>
          </div>
