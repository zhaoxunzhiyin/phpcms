...
<table cellpadding="2" cellspacing="1" width="98%">
	<tr> 
      ...
      <td><div class="mt-radio-inline">
          <label class="mt-radio mt-radio-outline"><input type="radio" name="setting[maptype]" value="2" <?php if($setting['maptype']==2) echo 'checked';?>> 百度地图 <span></span></label>
          <label class="mt-radio mt-radio-outline"><input type="radio" name="setting[maptype]" value="1" <?php if($setting['maptype']==1) echo 'checked';?> disabled> MAPABC <span></span></label>
        </div></td>
    </tr>	
	<tr> 
      <td>地图API Key </td>
