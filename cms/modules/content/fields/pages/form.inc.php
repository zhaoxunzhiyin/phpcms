	function pages($field, $value, $fieldinfo) {
		...
		if($value) {
			...
			$data .= "</select></label><label><span id=\"paginationtype1\" $con><label><input name=\"info[maxcharperpage]\" type=\"text\" id=\"maxcharperpage\" value=\"$v[1]\" size=\"8\" maxlength=\"8\"></label><label>".L('page_maxlength')."</label></span></label>";
			return $data;
		} else {
			...
			<label><span id=\"paginationtype1\" style=\"display:none\"><label><input name=\"info[maxcharperpage]\" type=\"text\" id=\"maxcharperpage\" value=\"10000\" size=\"8\" maxlength=\"8\"></label><label>".L('page_maxlength')."</label></span></label>";
		}
	}
