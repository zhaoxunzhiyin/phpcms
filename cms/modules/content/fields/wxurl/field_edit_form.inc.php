...
<table cellpadding="2" cellspacing="1" width="98%">
	...
	<tr> 
      ...
      <td><input type="text" name="setting[bformattribute]" value="<?php echo $setting['bformattribute'];?>" size="40" class="input-text"><br />javascript事件：get_wxurl('标题字段名称','关键词字段名称','内容字段名称')，内容必须是编辑器。</td>
    </tr>
    <tr> 
      <td>是否保存远程图片：</td>
