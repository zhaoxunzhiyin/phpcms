	function word($field, $value, $fieldinfo) {
		...
		$str .= '		url: \''.WEB_PATH.'api.php?op=get_word&module=content&catid='.intval($this->input->get('catid')).'&userid='.$this->userid.'&siteid='.$this->siteid.'&watermark='.$watermark.'&attachment='.$attachment.'&image_reduce='.$image_reduce.'&token='.csrf_hash().'\','.PHP_EOL;
