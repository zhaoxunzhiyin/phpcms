...
?>   
	...
	<td align="center"><a class="btn btn-xs green" href="<?php echo SELF;?>?m=poster&c=poster&a=edit&id=<?php echo $info['id'];?>&pc_hash=<?php echo dr_get_csrf_token();?>&menuid=<?php echo $this->input->get('menuid')?>" ><?php echo L('edit')?></a><a class="btn btn-xs blue" href="?m=poster&c=poster&a=stat&id=<?php echo $info['id']?>&spaceid=<?php echo $this->input->get('spaceid');?>"><?php echo L('stat')?></a></td>
	</tr>
<?php 
	}
}
