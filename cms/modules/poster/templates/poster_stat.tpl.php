...
<label class="mt-radio mt-radio-outline"><input name='range' type='radio' value='' onclick="redirect('?m=poster&c=poster&a=stat&id=<?php echo $_GET['id']?>&click=<?php echo $_GET['click']?>&pc_hash=<?php echo $_GET['pc_hash']?>&group=<?php echo $_GET['group']?>')" <?php if(!$_GET['range']) {?>checked<?php }?>> <?php echo L('all')?><span></span></label>
<label class="mt-radio mt-radio-outline"><input name='range' type='radio' value='1' onclick="redirect('?m=poster&c=poster&a=stat&id=<?php echo $_GET['id']?>&click=<?php echo $_GET['click']?>&pc_hash=<?php echo $_GET['pc_hash']?>&group=<?php echo $_GET['group']?>&range='+this.value)" <?php if($_GET['range']==1) {?>checked<?php }?>> <?php echo L('today')?><span></span></label>
<label class="mt-radio mt-radio-outline"><input name='range' type='radio' value='2' onclick="redirect('?m=poster&c=poster&a=stat&id=<?php echo $_GET['id']?>&click=<?php echo $_GET['click']?>&pc_hash=<?php echo $_GET['pc_hash']?>&group=<?php echo $_GET['group']?>&range='+this.value)" <?php if($_GET['range']==2) {?>checked<?php }?>> <?php echo L('yesterday')?><span></span></label>
<label class="mt-radio mt-radio-outline"><input name='range' type='radio' value='7' onclick="redirect('?m=poster&c=poster&a=stat&id=<?php echo $_GET['id']?>&click=<?php echo $_GET['click']?>&pc_hash=<?php echo $_GET['pc_hash']?>&group=<?php echo $_GET['group']?>&range='+this.value)" <?php if($_GET['range']==7) {?>checked<?php }?>> <?php echo L('one_week')?><span></span></label>
<label class="mt-radio mt-radio-outline"><input name='range' type='radio' value='14' onclick="redirect('?m=poster&c=poster&a=stat&id=<?php echo $_GET['id']?>&click=<?php echo $_GET['click']?>&pc_hash=<?php echo $_GET['pc_hash']?>&group=<?php echo $_GET['group']?>&range='+this.value)" <?php if($_GET['range']==14) {?>checked<?php }?>> <?php echo L('two_week')?><span></span></label>
<label class="mt-radio mt-radio-outline"><input name='range' type='radio' value='30' onclick="redirect('?m=poster&c=poster&a=stat&id=<?php echo $_GET['id']?>&click=<?php echo $_GET['click']?>&pc_hash=<?php echo $_GET['pc_hash']?>&group=<?php echo $_GET['group']?>&range='+this.value)" <?php if($_GET['range']==30) {?>checked<?php }?>> <?php echo L('one_month')?> <span></span></label><font color="red"><?php echo L('history_select')?>：</font><select name="year" onchange="if(this.value!=''){location='?m=poster&c=poster&a=stat&id=<?php echo $_GET['id']?>&click=<?php echo $_GET['click']?>&pc_hash=<?php echo $_GET['pc_hash']?>&group=<?php echo $_GET['group']?>&year='+this.value;}">
