...
$language = array('guestbook'=>'留言板', 'add_guestbook'=>'添加留言板', 'edit_guestbook'=>'编辑留言板', 'delete_guestbook'=>'删除留言板', 'guestbook_setting'=>'模块配置', 'add_type'=>'添加类别', 'edit_type'=>'编辑类别', 'list_type'=>'分类管理', 'check_register'=>'审核申请');
?>