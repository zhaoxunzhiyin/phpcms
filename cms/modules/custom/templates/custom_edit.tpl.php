...
<div class="form-group">
    ...
    <div class="col-md-10">
        <input type="text" name="custom[title]" id="title" value="<?php echo $title;?>" style="width:100%;" class="measure-input">
...
<div class="form-group" id="dr_row_content">
    ...
    <div class="col-md-10">
        <textarea class="dr_ueditor dr_ueditor_content" name="custom[content]" id="content"><?php echo $content;?></textarea>
