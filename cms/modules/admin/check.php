    ...
    public function public_do_index() {
        ...
        switch ($id) {
            ...
            case '03':
                ...
                if (!is_file(PC_PATH.'modules/404/controller.php')) {
                    $rt[] = '百度编辑器配置文件不存在：'.PC_PATH.'modules/404/controller.php';
                }

                if (!is_dir(PC_PATH.'modules/404/ueditor/')) {
                    $rt[] = '百度编辑器目录不存在：'.PC_PATH.'modules/404/ueditor/';
                }
