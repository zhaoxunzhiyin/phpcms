...
class module_api {
	...
	public function install($module = '') {
		...
		if(file_exists($this->installdir.'templates'.DIRECTORY_SEPARATOR)) {
			pc_base::load_sys_class('file')->copy_dir($this->installdir.'templates'.DIRECTORY_SEPARATOR, $this->installdir.'templates'.DIRECTORY_SEPARATOR, TPLPATH.SYS_TPL_NAME.DIRECTORY_SEPARATOR.$this->module.DIRECTORY_SEPARATOR);
			if (file_exists($this->installdir.'templates'.DIRECTORY_SEPARATOR.'name.inc.php')) {
				...
				unlink(TPLPATH.SYS_TPL_NAME.DIRECTORY_SEPARATOR.$this->module.DIRECTORY_SEPARATOR.'name.inc.php');
			}
		}
		return true;
	}
	...
	public function uninstall($module) {
		...
		if (is_dir(TPLPATH.SYS_TPL_NAME.DIRECTORY_SEPARATOR.$this->module)) {
			dr_dir_delete(TPLPATH.SYS_TPL_NAME.DIRECTORY_SEPARATOR.$this->module, TRUE);
		}
		$templatepath = TPLPATH.SYS_TPL_NAME.DIRECTORY_SEPARATOR;
		if (file_exists($templatepath.'config.php')) {
			$keyid = 'templates|'.SYS_TPL_NAME.'|'.$this->module;
