...
class admin {
	...
	final public function check_admin() {
		if(ROUTE_M =='admin' && ROUTE_C =='index' && in_array(ROUTE_A, array(SYS_ADMIN_PATH, 'fclient', 'public_logout'))) {
			return true;
		} else {
	...
	final public function check_url() {
		...
		if(ROUTE_M =='admin' && in_array(ROUTE_C, array('index', 'admin_manage')) && in_array(ROUTE_A, array(SYS_ADMIN_PATH, 'init', 'fclient', 'public_edit_pwd'))) {
			return true;
		}
		if (!HTTP_REFERER) {
