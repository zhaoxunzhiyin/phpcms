...
class cache_api {
	...
	private $input,$config,$cache,$db,$siteid,$categorys,$sitemodel_field_db,$sitemodel_db;
	...
	public function sitemodels() {
		...
		$sitemodel_datas = $this->sitemodel_db->select(array('type'=>0,'disabled'=>0), "*", '', 'sort,modelid');
		$model_array = array();
