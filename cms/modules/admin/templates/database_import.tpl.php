    ...
    <div class="table-list">
        <table width="100%" cellspacing="0">
            ...
            <tr class="odd gradeX">
                ...
                <td>-</td>
                <td>
                    <label><a href="<?php echo WEB_PATH;?>index.php?m=content&c=database&a=recovery&time=<?php echo $info['time'];?>" class="btn btn-xs dark btn-restore"><i class="fa fa-reply"></i> <?php echo L('还原');?></a></label>
    ...
    $(document).on("click", ".btn-restore", function () {
        ...
        if (that.href=='javascript:;') {
            layer.confirm("确定恢复备份？<br><font color='red'>建议先备份当前数据后再进行恢复操作！！！</font><br><font color='red'>当前数据库将被清空覆盖，请谨慎操作！！！</font>", {
                ...
                dr_db_submit('<?php echo L('还原')?>', 'myform', '<?php echo WEB_PATH;?>index.php?m=content&c=database&a=recovery');
            });
        } else {
