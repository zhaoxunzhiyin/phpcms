...
<input type="hidden" name="urlruleid" id="urlruleid" value="<?php echo $urlruleid;?>">
    ...
    <tr> 
      ...
      <td>
        <div class="mt-radio-inline">
          <label class="mt-radio mt-radio-outline"><input type="radio" value="1" name="info[ishtml]" <?php if($ishtml) echo 'checked';?>/> <?php echo L('yes');?> <span></span></label>
          <label class="mt-radio mt-radio-outline"><input type="radio" value="0" name="info[ishtml]" <?php if(!$ishtml) echo 'checked';?>/><?php echo L('no');?> <span></span></label>
        </div>
    </td>
    </tr>
    <tr> 
    ...
    <tr> 
      <th width="20%"><?php echo L('urlrule_func')?> :</th>
       <td><?php echo L('complete_part_path');?>：<label><input type="text" name="f1" value="{$categorydir}" size="15" class="input-botton"></label>，<?php echo L('category_path');?>：<label><input type="text" name="f1" value="{$catdir}" size="10" class="input-botton"></label>，<?php echo L('catid');?>：<label><input type="text" name="f1" value="{$catid}" size="5" class="input-botton"></label>
       <div class="bk6"></div>
