...
<div id="ew-lock-screen-group" style="display :<?php if(param::get_session('lock_screen')==0) echo 'none';?>">
    <div class="lock-screen-wrapper">
        ...
        <div class="lock-screen-form">
            <input id="lock_password" placeholder="<?php echo L('lockscreen_status');?>" class="lock-screen-psw" type="password">
        ...
        if ($form.hasClass('show-psw')) {
            ...
            if (!psw) {
                ...
                $.ajax({
                    ...
                    data: {'lock_password': psw, '<?php echo SYS_TOKEN_NAME;?>': $(".lock-screen-form input[name='<?php echo SYS_TOKEN_NAME;?>']").val()},
