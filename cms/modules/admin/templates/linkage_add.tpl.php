...
<label class="mt-radio mt-radio-outline"><input name="info[style]" value="0" checked="checked" type="radio"> <?php echo L('drop_down_style')?> <span></span></label>
<label class="mt-radio mt-radio-outline"><input name="info[style]" value="1" type="radio"> <?php echo L('pop_style')?> <span></span></label>
</div>
</td>
</tr>
