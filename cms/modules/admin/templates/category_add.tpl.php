...
<form name="myform" id="myform" action="?m=admin&c=category&a=add" method="post" onsubmit="return checkall()">
<div class="pad-10">
<div class="col-tab">
 ...
 <tr>
     <th><?php echo L('add_category_types');?>：</th>
      ...
      <tr>
        ...
        <table width="100%"><tr><td width="310"><textarea name="batch_add" maxlength="255" style="width:300px;height:60px;"></textarea></td>
        <td align="left">
