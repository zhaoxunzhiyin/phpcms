...
<?php if($list){?>
 <div class="btn"><input type="button" class="button" name="dosubmit" value="<?php echo L('清空全部')?>" onclick="ajax_option('?m=admin&c=index&a=public_error_log_del&time=<?php echo $time;?>', '你确定要清空全部记录吗？')" /></div>
<?php }?>
