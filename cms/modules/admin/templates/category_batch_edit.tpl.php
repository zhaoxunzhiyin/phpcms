...
<div id="table-lists" class="table-scrollable">
    ...
    ?>
        ...
        <div class="mt-radio-inline">
          <label class="mt-radio mt-radio-outline"><input boxid="content_ishtml" catid="<?php echo $catid;?>" type='radio' name='setting[<?php echo $catid;?>][content_ishtml]' value='1' <?php if($cat['setting']['content_ishtml']) echo 'checked';?> onClick="change_radio(event,'content_ishtml',1,'show');urlrule('show',1,<?php echo $catid;?>)"> <?php echo L('yes');?> <span></span></label>
          <label class="mt-radio mt-radio-outline"><input boxid="content_ishtml" catid="<?php echo $catid;?>" type='radio' name='setting[<?php echo $catid;?>][content_ishtml]' value='0' <?php if(!$cat['setting']['content_ishtml']) echo 'checked';?>  onClick="change_radio(event,'content_ishtml',0,'show');urlrule('show',0,<?php echo $catid;?>)"> <?php echo L('no');?> <span></span></label>
        </div>
      </td>
    <?php
        }
    ...
    ?>
        ...
        <div class="mt-radio-inline">
          <label class="mt-radio mt-radio-outline"><input boxid="create_to_html_root" onclick="change_radio(event,'create_to_html_root',1)" type='radio' name='setting[<?php echo $catid;?>][create_to_html_root]' value='1' <?php if($cat['setting']['create_to_html_root']) echo 'checked';?> > <?php echo L('yes');?> <span></span></label>
          <label class="mt-radio mt-radio-outline"><input boxid="create_to_html_root" onclick="change_radio(event,'create_to_html_root',0)" type='radio' name='setting[<?php echo $catid;?>][create_to_html_root]' value='0' <?php if(!$cat['setting']['create_to_html_root']) echo 'checked';?> > <?php echo L('no');?> <span></span></label>
        </div>
      </td>
    <?php
        }
