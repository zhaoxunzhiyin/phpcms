...
<input type="hidden" name="id" value="<?php echo $id?>">
    <div class="form-body">
        <div class="form-group" id="dr_row_name">
            ...
            <div class="col-xs-7">
                <input type="text" onblur="topinyin('<?php echo WEB_PATH;?>api.php?op=pinyin','name','code',12);" class="form-control" id="name" name="data[name]" value="<?php echo htmlspecialchars($data['name']);?>">
            ...
            <div class="col-xs-7">
                <div class="mt-radio-inline">
                    <label class="mt-radio">
                        <input type="radio" name="data[style]" value="0"<?php if(!$data['style']) {?> checked<?php }?>> <?php echo L('linkage_option_style');?>
                        <span></span>
                    </label>
                    <label class="mt-radio">
                        <input type="radio" name="data[style]" value="1"<?php if($data['style']) {?> checked<?php }?>> <?php echo L('linkage_select_style');?>
                        <span></span>
                    </label>
                </div>
            </div>
