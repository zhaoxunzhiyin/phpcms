...
<fieldset>
  ...
  <tr>
    ...
    <td class="y-bg"><div class="mt-checkbox-inline">
          <label class="mt-checkbox mt-checkbox-outline"><input type="checkbox" class="inputcheckbox" name="pasv" id="pasv" value="1" size="30"<?php if ($data['pasv']){echo ' checked';}?> /><?php echo L('yes')?> <span></span></label>
        </div></td>
  </tr>
    <tr>
    <th><?php echo L('ssl_connection')?>：</th>
    <td class="y-bg"><div class="mt-checkbox-inline">
          <label class="mt-checkbox mt-checkbox-outline"><input type="checkbox" class="inputcheckbox" name="ssl" id="ssl" value="1" size="30"<?php if ($data['ssl']){echo ' checked';}?> <?php if(!$this->ssl){ echo 'disabled';}?> /><?php echo L('yes')?> <span></span></label><?php if(!$this->ssl){ echo '<span style="color:red">'.L('your_server_will_not_support_the_ssl_connection').'</a>';}?>
        </div></td>
  </tr>
    </tr>
    <tr>
