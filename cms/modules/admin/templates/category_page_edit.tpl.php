    ...
    <div class="portlet-title tabbable-line">
        <ul class="nav nav-tabs" style="float:left;">
            ...
            <li<?php if ($page==5) {?> class="active"<?php }?>>
                <a data-toggle="tab_5" onclick="$('#dr_page').val('5')"<?php if (is_mobile()) {echo ' onmouseover="layer.tips(\''.L('extention_field').'\',this,{tips: [1, \'#fff\']});" onmouseout="layer.closeAll();"';}?>> <i class="fa fa-code"></i> <?php if (!is_mobile()) {echo L('extention_field');}?> </a>
            </li>
            <?php }?>
        </ul>
    </div>
            ...
            <div class="tab-pane<?php if ($page==4) {?> active<?php }?>" id="tab_4">
			  ...
			  <thead>
				...
				?>
				  ...
				  <td align="center"><label class="mt-checkbox mt-checkbox-outline"><input type="checkbox" name="priv_roleid[]" <?php echo $disableds;?> <?php echo $this->check_category_priv('init',$roleid);?> value="init,<?php echo $roleid;?>" ><span></span></label></td>
			  </tr>
			  <?php }?>
