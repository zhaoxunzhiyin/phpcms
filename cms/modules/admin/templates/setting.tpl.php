                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            <label><a class="btn btn-sm blue" href="http://lbsyun.baidu.com/apiconsole/center" target="_blank"><i class="fa fa-link"></i> <?php echo L('setting_apply_immediately');?> </a></label>
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            <label><a class="btn btn-sm red" href="javascript:iframe_show('<?php echo L('setting_keyword_word')?>', '?m=admin&c=setting&a=public_test_index&kw='+$('#mykw').val()+'&num='+$('#baidu_qcnum').val());"> <?php echo L('setting_keyword_participle')?> </a></label>
                        </div>
                    </div>
...
function test_mail() {
    ...
    $.ajax({type: "POST",dataType:"json", url: "?m=admin&c=setting&a=public_test_mail&mail_to="+$('#mail_to').val()+"&"+Math.random(), data: {mail_type:mail_type,mail_server:$('#mail_server').val(),mail_port:$('#mail_port').val(),mail_user:$('#mail_user').val(),mail_password:$('#mail_password').val(),mail_auth:mail_auth,mail_from:$('#mail_from').val(),<?php echo csrf_token();?>:$("#myform input[name='<?php echo csrf_token();?>']").val()},
