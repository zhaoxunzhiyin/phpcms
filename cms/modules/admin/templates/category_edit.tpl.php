...
<div class="portlet light bordered">
    <div class="portlet-title tabbable-line">
        <ul class="nav nav-tabs" style="float:left;">
            <li<?php if ($page==0) {?> class="active"<?php }?>>
                <a data-toggle="tab_0" onclick="$('#dr_page').val('0')"<?php if (is_mobile()) {echo ' onmouseover="layer.tips(\''.L('catgory_basic').'\',this,{tips: [1, \'#fff\']});" onmouseout="layer.closeAll();"';}?>> <i class="fa fa-cog"></i> <?php if (!is_mobile()) {echo L('catgory_basic');}?> </a>
            </li>
            <li<?php if ($page==1) {?> class="active"<?php }?>>
                <a data-toggle="tab_1" onclick="$('#dr_page').val('1')"<?php if (is_mobile()) {echo ' onmouseover="layer.tips(\''.L('catgory_createhtml').'\',this,{tips: [1, \'#fff\']});" onmouseout="layer.closeAll();"';}?>> <i class="fa fa-file-code-o"></i> <?php if (!is_mobile()) {echo L('catgory_createhtml');}?> </a>
            </li>
            <li<?php if ($page==2) {?> class="active"<?php }?>>
                <a data-toggle="tab_2" onclick="$('#dr_page').val('2')"<?php if (is_mobile()) {echo ' onmouseover="layer.tips(\''.L('catgory_template').'\',this,{tips: [1, \'#fff\']});" onmouseout="layer.closeAll();"';}?>> <i class="fa fa-html5"></i> <?php if (!is_mobile()) {echo L('catgory_template');}?> </a>
            </li>
            <li<?php if ($page==3) {?> class="active"<?php }?>>
                <a data-toggle="tab_3" onclick="$('#dr_page').val('3')"<?php if (is_mobile()) {echo ' onmouseover="layer.tips(\''.L('catgory_seo').'\',this,{tips: [1, \'#fff\']});" onmouseout="layer.closeAll();"';}?>> <i class="fa fa-internet-explorer"></i> <?php if (!is_mobile()) {echo L('catgory_seo');}?> </a>
            </li>
            <li<?php if ($page==4) {?> class="active"<?php }?>>
                <a data-toggle="tab_4" onclick="$('#dr_page').val('4')"<?php if (is_mobile()) {echo ' onmouseover="layer.tips(\''.L('catgory_private').'\',this,{tips: [1, \'#fff\']});" onmouseout="layer.closeAll();"';}?>> <i class="fa fa-user-circle"></i> <?php if (!is_mobile()) {echo L('catgory_private');}?> </a>
            </li>
            <li<?php if ($page==5) {?> class="active"<?php }?>>
                <a data-toggle="tab_5" onclick="$('#dr_page').val('5')"<?php if (is_mobile()) {echo ' onmouseover="layer.tips(\''.L('catgory_readpoint').'\',this,{tips: [1, \'#fff\']});" onmouseout="layer.closeAll();"';}?>> <i class="fa fa-rmb"></i> <?php if (!is_mobile()) {echo L('catgory_readpoint');}?> </a>
            </li>
            <?php if($forminfos && is_array($forminfos['base'])) {?>
            <li<?php if ($page==6) {?> class="active"<?php }?>>
                <a data-toggle="tab_6" onclick="$('#dr_page').val('6')"<?php if (is_mobile()) {echo ' onmouseover="layer.tips(\''.L('extention_field').'\',this,{tips: [1, \'#fff\']});" onmouseout="layer.closeAll();"';}?>> <i class="fa fa-code"></i> <?php if (!is_mobile()) {echo L('extention_field');}?> </a>
            </li>
            <?php }?>
        </ul>
    </div>
    <div class="portlet-body form">
        <div class="tab-content">
			...
			$disableds = $category_items[$catid] ? 'disabled' : '';
			...
			echo form::select($model_datas,$modelid,'name="info[modelid]" id="modelid" '.$disableds,L('select_model'));
		...
		?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <textarea class="form-control" name="info[description]" style="height:90px;"><?php echo $description;?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
	...
	?>
            ...
            <div class="tab-pane<?php if ($page==1) {?> active<?php }?>" id="tab_1">
                <div class="form-body">
                    ...
                    <div class="form-group" id="tr_domain" style="display:<?php if(!$setting['ishtml']) echo 'none';?>">
                        ...
                        <div class="col-md-9">
                            <label><input class="form-control input-large" type="text" id="url" name="info[url]" value="<?php if(preg_match('/^http(s?):\/\/([a-z0-9\-\.]+)\/$/i',$url)) echo $url;?>"></label>
            ...
            <div class="tab-pane<?php if ($page==2) {?> active<?php }?>" id="tab_2">
                <div class="form-body">
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label"><?php echo L('模板应用到子栏目')?></label>
                        <div class="col-md-9">
                            <div class="mt-radio-inline">
                                <label class="mt-radio mt-radio-outline"><input type='radio' name='template_child' value='1'> <?php echo L('yes');?> <span></span></label>
                                <label class="mt-radio mt-radio-outline"><input type='radio' name='template_child' value='0' checked> <?php echo L('no');?> <span></span></label>
                            </div>
                        </div>
                    </div>
            ...
            <div class="tab-pane<?php if ($page==3) {?> active<?php }?>" id="tab_3">
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <textarea class="form-control" name="setting[meta_title]" style="height:90px;"><?php echo $setting['meta_title'];?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <textarea class="form-control" name="setting[meta_keywords]" style="height:90px;"><?php echo $setting['meta_keywords'];?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <textarea class="form-control" name="setting[meta_description]" style="height:90px;"><?php echo $setting['meta_description'];?></textarea>
            ...
            <div class="tab-pane<?php if ($page==4) {?> active<?php }?>" id="tab_4">
                <div class="form-body">
                        ...
                        <div class="col-md-9">
                            <div class="user_group J_check_wrap">
                                <dl>
                                    ...
                                    ?>
                                    <dt>
                                        <label class="mt-checkbox mt-checkbox-outline"><input type="checkbox" data-direction="y" data-checklist="J_check_priv_roleid<?php echo $roleid;?>" class="checkbox J_check_all" <?php echo $disableds;?><?php if ($this->check_category_priv('init',$roleid) && $this->check_category_priv('add',$roleid) && $this->check_category_priv('edit',$roleid) && $this->check_category_priv('delete',$roleid) && $this->check_category_priv('listorder',$roleid) && $this->check_category_priv('push',$roleid) && $this->check_category_priv('remove',$roleid) && $this->check_category_priv('copy',$roleid) && $this->check_category_priv('recycle_init',$roleid) && $this->check_category_priv('recycle',$roleid) && $this->check_category_priv('update',$roleid)) {echo ' checked';}?>/><?php echo $rolrname?><span></span></label>
                                    </dt>
                                    <dd>
                                        <label class="mt-checkbox mt-checkbox-outline"><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo $roleid;?>" name="priv_roleid[]" <?php echo $disableds;?> <?php echo $this->check_category_priv('init',$roleid);?> value="init,<?php echo $roleid;?>" ><?php echo L('view');?><span></span></label>
                                        <label class="mt-checkbox mt-checkbox-outline"><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo $roleid;?>" name="priv_roleid[]" <?php echo $disableds;?> <?php echo $this->check_category_priv('add',$roleid);?> value="add,<?php echo $roleid;?>" ><?php echo L('add');?><span></span></label>
                                        <label class="mt-checkbox mt-checkbox-outline"><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo $roleid;?>" name="priv_roleid[]" <?php echo $disableds;?> <?php echo $this->check_category_priv('edit',$roleid);?> value="edit,<?php echo $roleid;?>" ><?php echo L('edit');?><span></span></label>
                                        <label class="mt-checkbox mt-checkbox-outline"><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo $roleid;?>" name="priv_roleid[]" <?php echo $disableds;?> <?php echo $this->check_category_priv('delete',$roleid);?> value="delete,<?php echo $roleid;?>" ><?php echo L('delete');?><span></span></label>
                                        <label class="mt-checkbox mt-checkbox-outline"><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo $roleid;?>" name="priv_roleid[]" <?php echo $disableds;?> <?php echo $this->check_category_priv('listorder',$roleid);?> value="listorder,<?php echo $roleid;?>" ><?php echo L('listorder');?><span></span></label>
                                        <label class="mt-checkbox mt-checkbox-outline"><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo $roleid;?>" name="priv_roleid[]" <?php echo $disableds;?> <?php echo $this->check_category_priv('push',$roleid);?> value="push,<?php echo $roleid;?>" ><?php echo L('push');?><span></span></label>
                                        <label class="mt-checkbox mt-checkbox-outline"><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo $roleid;?>" name="priv_roleid[]" <?php echo $disableds;?> <?php echo $this->check_category_priv('remove',$roleid);?> value="remove,<?php echo $roleid;?>" ><?php echo L('move');?><span></span></label>
                                        <label class="mt-checkbox mt-checkbox-outline"><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo $roleid;?>" name="priv_roleid[]" <?php echo $disableds;?> <?php echo $this->check_category_priv('copy',$roleid);?> value="copy,<?php echo $roleid;?>" ><?php echo L('copy');?><span></span></label>
                                        <label class="mt-checkbox mt-checkbox-outline"><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo $roleid;?>" name="priv_roleid[]" <?php echo $disableds;?> <?php echo $this->check_category_priv('recycle_init',$roleid);?> value="recycle_init,<?php echo $roleid;?>" ><?php echo L('recycle');?><span></span></label>
                                        <label class="mt-checkbox mt-checkbox-outline"><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo $roleid;?>" name="priv_roleid[]" <?php echo $disableds;?> <?php echo $this->check_category_priv('recycle',$roleid);?> value="recycle,<?php echo $roleid;?>" ><?php echo L('restore');?><span></span></label>
                                        <label class="mt-checkbox mt-checkbox-outline"><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo $roleid;?>" name="priv_roleid[]" <?php echo $disableds;?> <?php echo $this->check_category_priv('update',$roleid);?> value="update,<?php echo $roleid;?>" ><?php echo L('update');?><span></span></label>
                                    </dd>
                                    <?php }?>
                                </dl>
                            </div>
                        ...
                        <div class="col-md-9">
                            <div class="user_group J_check_wrap">
                                <dl>
                                    ...
                                    ?>
                                    <dt>
                                        <label class="mt-checkbox mt-checkbox-outline"><input type="checkbox" data-direction="y" data-checklist="J_check_priv_groupid<?php echo $_value['groupid'];?>" class="checkbox J_check_all"<?php if ($this->check_category_priv('visit',$_value['groupid'],0) && $this->check_category_priv('add',$_value['groupid'],0) && $this->check_category_priv('edit',$_value['groupid'],0) && $this->check_category_priv('delete',$_value['groupid'],0)) {echo ' checked';}?>/><?php echo $_value['name'];?><span></span></label>
                                    </dt>
                                    <dd>
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label"><?php echo L('apply_to_child')?></label>
                        <div class="col-md-9">
                            <div class="mt-radio-inline">
                                <label class="mt-radio mt-radio-outline"><input type='radio' name='priv_child' value='1'> <?php echo L('yes');?> <span></span></label>
                                <label class="mt-radio mt-radio-outline"><input type='radio' name='priv_child' value='0' checked> <?php echo L('no');?> <span></span></label>
                            </div>
                        </div>
                    </div>
            ...
            <div class="tab-pane<?php if ($page==5) {?> active<?php }?>" id="tab_5">
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <label><input class="form-control input-large" type="text" name="setting[presentpoint]" id="presentpoint" value="<?php echo $setting['presentpoint'];?>"></label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <label><input class="form-control input-large" type="text" name="setting[defaultchargepoint]" id="defaultchargepoint" value="<?php echo $setting['defaultchargepoint'];?>"></label>
                            <label><select name="setting[paytype]"><option value="0" <?php if(!$setting['paytype']) echo 'selected';?>><?php echo L('readpoint');?></option><option value="1" <?php if($setting['paytype']) echo 'selected';?>><?php echo L('money');?></option></select></label>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label"><?php echo L('repeatchargedays')?></label>
                        <div class="col-md-9">
                            <label><input class="form-control input-large" type="text" name="setting[repeatchargedays]" id="repeatchargedays" value="<?php echo $setting['repeatchargedays'];?>"></label>
