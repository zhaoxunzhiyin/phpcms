        ...
        <div class="portlet-body">
            <div class="form-body">
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                       <?php echo form::select($modules,'content',"name='info[module]' id='module' onchange='change(this.value)'");?>
                    </div>
                </div>
                <div class="form-group" id="dr_row_file">
                    <label class="col-md-2 control-label"><?php echo L('urlrule_file');?></label>
                    <div class="col-md-10">
                        <label><input type="text" name="info[file]" id="file" value="" class="form-control" readonly></label>
                        <span class="type"><?php echo form::select(array('category'=>'栏目', 'show'=>'内容', 'search'=>'搜索'),'',"name='type' id='type' onchange='change_type(this.value)'", L('请选择'));?></span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <div class="mt-radio-inline">
                            <label class="mt-radio">
                                <input name="info[ishtml]" type="radio" value="1"> <?php echo L('yes');?>
                                <span></span>
                            </label>
                            <label class="mt-radio">
                                <input name="info[ishtml]" type="radio" value="0" checked> <?php echo L('no');?>
                                <span></span>
                            </label>
                        </div>
                    </div>
                ...
                <div class="form-group" id="dr_row_example">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="info[example]" id="example" value="" class="form-control">
                    </div>
                </div>
                <div class="form-group" id="dr_row_urlrule">
                    <label class="col-md-2 control-label"><?php echo L('urlrule_url');?></label>
                    <div class="col-md-10">
                        <input type="text" name="info[urlrule]" id="urlrule" value="" class="form-control">
                    </div>
                </div>
                <div class="form-group">
