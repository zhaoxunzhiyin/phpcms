            ...
            <div class="tab-pane<?php if ($page==0) {?> active<?php }?>" id="tab_0">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group" id="dr_row_catname">
                        ...
                        <div class="col-md-9">
                            <label><input class="form-control input-large" type="text" name="info[catname]" id="catname" value="" onblur="topinyin('<?php echo WEB_PATH;?>api.php?op=pinyin','catname','catdir',12);"></label>
                        </div>
                    </div>
