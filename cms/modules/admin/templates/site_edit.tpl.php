    ...
    <div class="portlet-title tabbable-line">
        <ul class="nav nav-tabs" style="float:left;">
            ...
            <li<?php if ($page==1) {?> class="active"<?php }?>>
                <a data-toggle="tab_1" onclick="$('#dr_page').val('1')"<?php if (is_mobile()) {echo ' onmouseover="layer.tips(\''.L('mobile_configuration').'\',this,{tips: [1, \'#fff\']});" onmouseout="layer.closeAll();"';}?>> <i class="fa fa-mobile"></i> <?php if (!is_mobile()) {echo L('mobile_configuration');}?> </a>
            </li>
            <li<?php if ($page==2) {?> class="active"<?php }?>>
                <a data-toggle="tab_2" onclick="$('#dr_page').val('2')"<?php if (is_mobile()) {echo ' onmouseover="layer.tips(\''.L('seo_configuration').'\',this,{tips: [1, \'#fff\']});" onmouseout="layer.closeAll();"';}?>> <i class="fa fa-internet-explorer"></i> <?php if (!is_mobile()) {echo L('seo_configuration');}?> </a>
            </li>
            <li<?php if ($page==3) {?> class="active"<?php }?>>
                <a data-toggle="tab_3" onclick="$('#dr_page').val('3')"<?php if (is_mobile()) {echo ' onmouseover="layer.tips(\''.L('release_point_configuration').'\',this,{tips: [1, \'#fff\']});" onmouseout="layer.closeAll();"';}?>> <i class="fa fa-send"></i> <?php if (!is_mobile()) {echo L('release_point_configuration');}?> </a>
            </li>
            <li<?php if ($page==4) {?> class="active"<?php }?>>
                <a data-toggle="tab_4" onclick="$('#dr_page').val('4')"<?php if (is_mobile()) {echo ' onmouseover="layer.tips(\''.L('template_style_configuration').'\',this,{tips: [1, \'#fff\']});" onmouseout="layer.closeAll();"';}?>> <i class="fa fa-html5"></i> <?php if (!is_mobile()) {echo L('template_style_configuration');}?> </a>
            </li>
            <li<?php if ($page==5) {?> class="active"<?php }?>>
                <a data-toggle="tab_5" onclick="$('#dr_page').val('5')"<?php if (is_mobile()) {echo ' onmouseover="layer.tips(\''.L('site_att_config').'\',this,{tips: [1, \'#fff\']});" onmouseout="layer.closeAll();"';}?>> <i class="fa fa-folder"></i> <?php if (!is_mobile()) {echo L('site_att_config');}?> </a>
            </li>
            <li<?php if ($page==6) {?> class="active<?php if (SYS_EDITOR) {?> hide<?php }?>"<?php }else{?><?php if (SYS_EDITOR) {?> class="hide"<?php }}?>>
                <a data-toggle="tab_6" onclick="$('#dr_page').val('6')"<?php if (is_mobile()) {echo ' onmouseover="layer.tips(\''.L('att_ueditor').'\',this,{tips: [1, \'#fff\']});" onmouseout="layer.closeAll();"';}?>> <i class="fa fa-edit"></i> <?php if (!is_mobile()) {echo L('att_ueditor');}?> </a>
            </li>
            <?php if($forminfos && is_array($forminfos['base'])) {?>
            <li<?php if ($page==7) {?> class="active"<?php }?>>
                <a data-toggle="tab_7" onclick="$('#dr_page').val('7')"<?php if (is_mobile()) {echo ' onmouseover="layer.tips(\''.L('extention_field').'\',this,{tips: [1, \'#fff\']});" onmouseout="layer.closeAll();"';}?>> <i class="fa fa-code"></i> <?php if (!is_mobile()) {echo L('extention_field');}?> </a>
            </li>
            <?php }?>
        </ul>
    </div>
            ...
            <div class="tab-pane<?php if ($page==1) {?> active<?php }?>" id="tab_1">
                <div class="form-body">
                    ...
                    <div class="form-group dr_zsy"<?php if($data['mobilemode']==-1) echo ' style="display: none"';?>>
                        ...
                        <div class="col-md-9">
                            <div class="form-control-static"><?php if (IS_DEV) {echo L(TPLPATH.$data['default_style'].'/mobile/index.html');} else {echo L('mobile_template_style');}?></div>
                        </div>
                    </div>
                    <?php if (!$is_tpl) {?>
                    <div class="form-group">
