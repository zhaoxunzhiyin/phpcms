            ...
            <div class="tab-pane<?php if ($page==5) {?> active<?php }?>" id="tab_5">
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" type="text" id="upload_allowext" name="setting[upload_allowext]" value="jpg|jpeg|gif|webp|png|doc|docx|xls|xlsx|ppt|pptx|pdf|txt|rar|zip" >
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="tab-pane<?php if ($page==6) {?> active<?php }?>" id="tab_6">
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" type="text" id="imageAllowFiles" name="setting[imageAllowFiles]" value="png|jpg|jpeg|gif|webp" >
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" type="text" id="catcherAllowFiles" name="setting[catcherAllowFiles]" value="png|jpg|jpeg|gif|webp" >
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" type="text" id="videoAllowFiles" name="setting[videoAllowFiles]" value="mkv|avi|rm|rmvb|mpeg|mpg|ogg|ogv|mov|wmv|mp4|webm|mp3|wav|mid" >
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" type="text" id="musicAllowFiles" name="setting[musicAllowFiles]" value="mkv|avi|rm|rmvb|mpeg|mpg|ogg|ogv|mov|wmv|mp4|webm|mp3|wav|mid" >
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" type="text" id="fileAllowFiles" name="setting[fileAllowFiles]" value="png|jpg|jpeg|gif|webp|mkv|avi|rm|rmvb|mpeg|mpg|ogg|ogv|mov|wmv|mp4|webm|mp3|wav|mid|rar|zip|tar|gz|7z|bz2|cab|iso|doc|docx|xls|xlsx|ppt|pptx|pdf|txt|md|xml" >
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group" style="display: none">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" type="text" id="imageManagerAllowFiles" name="setting[imageManagerAllowFiles]" value="png|jpg|jpeg|gif|webp" >
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group" style="display: none">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" type="text" id="fileManagerAllowFiles" name="setting[fileManagerAllowFiles]" value="png|jpg|jpeg|gif|webp|mkv|avi|rm|rmvb|mpeg|mpg|ogg|ogv|mov|wmv|mp4|webm|mp3|wav|mid|rar|zip|tar|gz|7z|bz2|cab|iso|doc|docx|xls|xlsx|ppt|pptx|pdf|txt|md|xml" >
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group" style="display: none">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" type="text" id="videoManagerAllowFiles" name="setting[videoManagerAllowFiles]" value="mkv|avi|rm|rmvb|mpeg|mpg|ogg|ogv|mov|wmv|mp4|webm|mp3|wav|mid" >
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group" style="display: none">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" type="text" id="musicManagerAllowFiles" name="setting[musicManagerAllowFiles]" value="mkv|avi|rm|rmvb|mpeg|mpg|ogg|ogv|mov|wmv|mp4|webm|mp3|wav|mid" >
                        </div>
                    </div>
