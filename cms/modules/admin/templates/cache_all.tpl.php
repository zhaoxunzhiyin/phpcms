        ...
        <table class="table table-striped table-bordered table-hover table-checkable dataTable">
            ...
            <tr>
                ...
                <td style="overflow:auto">
                    <label>
                        <a href="javascript:;" onclick="my_update_cache('<?php echo $id;?>', '<?php echo $t['function'];?>', '<?php echo $t['mod'];?>', '<?php echo $t['file'];?>', '<?php echo $t['param'];?>');" class="btn red btn-xs<?php if ($t['function'] != 'update_thumb' && $t['function'] != 'update_rewrite_routes') {?> update_cache<?php }?>"><i class="fa fa-refresh"></i> <?php echo L('立即更新');?> </a>
                    </label>
