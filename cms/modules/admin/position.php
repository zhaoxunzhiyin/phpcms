...
class position extends admin {
	private $input, $db, $db_data, $db_content, $sites, $cache_api, $sitemodel_db;
	...
	public function public_item() {	
		if(IS_POST) {
			...
			$big_menu = array('javascript:artdialog(\'add\',\'?m=admin&c=position&a=add\',\''.L('posid_add').'\',500,300);void(0);', L('posid_add'));			
