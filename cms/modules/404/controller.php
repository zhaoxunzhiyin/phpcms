...
class controller {
	private $input,$siteid,$grouplist,$isadmin,$userid,$groupid,$filename,$imageAllowFiles,$catcherAllowFiles,$videoAllowFiles,$musicAllowFiles,$fileAllowFiles,$imageManagerAllowFiles,$fileManagerAllowFiles,$videoManagerAllowFiles,$musicManagerAllowFiles,$config;
