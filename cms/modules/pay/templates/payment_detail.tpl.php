...
<td>
<textarea name="description" rows="2" cols="10" id="description" class="dr_ueditor dr_ueditor_content"><?php echo $pay_desc?></textarea>
...
<td id="paymethod"><div class="mt-radio-inline">
<label class="mt-radio mt-radio-outline"><input name="pay_method" value="0" type="radio" <?php echo ($pay_method == 1) ? '': 'checked'?>> <?php echo L('pay_method_rate')?> <span></span></label>
<label class="mt-radio mt-radio-outline"><input name="pay_method" value="1" type="radio" <?php echo ($pay_method == 0) ? '': 'checked'?>> <?php echo L('pay_method_fix')?> <span></span></label>
</div></td>
</tr>
<tr><td></td>
<td>
