    	...
    	if ($receive_data) {
			...
			if ($v_md5str==$md5string) {
				...
				if($v_pstatus=="20") {
					...
					log_message('error', 'chinabank GET: order_status=30');
					return false;
				}
			} else { 
			...
			log_message('error', 'GET: no return');
    	...
    	if ($receive_data) {
			...
			if ($v_md5str==$md5string) {
				...
				if($v_pstatus=="20") {
					...
					log_message('error', 'chinabank notify: order_status=30');
					return false;
				}
			} else { 
				return false;
			...
			log_message('error', 'notify: no return');
			return false;
		}  	
    }
