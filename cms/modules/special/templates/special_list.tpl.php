...
<a class="btn btn-xs green" href="?m=special&c=special&a=edit&specialid=<?php echo $info['id']?>&menuid=<?php echo $this->input->get('menuid')?>"><?php echo L('edit_special')?></a>
<a class="btn btn-xs red" href="javascript:void(0);" onclick="Dialog.confirm('<?php echo L('confirm', array('message'=>new_addslashes(new_html_special_chars($info['title']))))?>',function(){redirect('?m=special&c=special&a=delete&id=<?php echo $info['id']?>&pc_hash='+pc_hash);});"><?php echo L('del_special')?></a>
