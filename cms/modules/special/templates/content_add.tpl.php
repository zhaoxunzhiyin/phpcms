...
<table width="100%" cellspacing="0" class="table_form">
    ...
    <tr>
      ...
      <td><input type='text' name='info[keywords]' id='keywords' value='' style='50' style='width:400px' data-role='tagsinput'>  <?php echo L('more_keywords_with_blanks')?></td>
    </tr>
	<tr>
...
<label class="mt-checkbox mt-checkbox-outline"><input type='checkbox' name='auto_thumb' value="1" checked><?php echo L('iscutcotent_pic')?><span></span></label><input type="text" name="auto_thumb_no" value="1" size="2" class=""><?php echo L('picture2thumb')?>
</div></td>
	<tr>
