            ...
            <div class="tab-pane<?php if ($page==0) {?> active<?php }?>" id="tab_0">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group" id="dr_row_title">
                        ...
                        <div class="col-md-9">
                            <label><input class="form-control input-large" type="text" id="title" name="special[title]" value="" onblur="topinyin('<?php echo WEB_PATH;?>api.php?op=pinyin','title','filename',12);"></label>
                            <span class="help-block" id="titleTip"></span>
                        </div>
                    </div>
                    <div class="form-group" id="dr_row_banner">
                    ...
                    <div class="form-group" id="dr_row_thumb">
                    ...
                    <div class="form-group" id="dr_row_filename">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                                ...
                                <table class="table table-nomargin table-bordered table-striped table-bordered table-advance">
                                    ...
                                    <tbody id="dr_type_body">
                                        <tr id="dr_ftable_type_row_1">
                                            <td id="dr_row_type_name_1"><input type="text" class="form-control" id="type_name_1" name="type[1][name]" value="" onblur="topinyin('<?php echo WEB_PATH;?>api.php?op=pinyin','type_name_1','type_path_1',12);"></td>
                                            <td id="dr_row_type_path_1"><input type="text" class="form-control" id="type_path_1" name="type[1][typedir]" value=""></td>
                            ...
                            <script>
                            var special_type = {"tpl":" <tr id=\"dr_ftable_type_row_{hang}\"> <td><input type=\"text\" class=\"form-control\" id=\"type_name_{hang}\" name=\"type[{hang}][name]\" value=\"\" onblur=\"topinyin('<?php echo WEB_PATH;?>api.php?op=pinyin','type_name_{hang}','type_path_{hang}',12);\"><\/td> <td><input type=\"text\" class=\"form-control\" id=\"type_path_{hang}\" name=\"type[{hang}][typedir]\" value=\"\"><\/td> <td><input type=\"text\" class=\"form-control\" name=\"type[{hang}][listorder]\" value=\"{hang}\"><\/td> <td style=\"text-align: center\"><button type=\"button\" class=\"btn red btn-xs\" onClick=\"dr_del_table_type(this)\"> <i class=\"fa fa-trash\"><\/i> <\/button><\/td> <\/tr>","id":1};
...
$(document).ready(function(){
    ...
    $("#type_name_1").formValidator({tipid:"typeTip",onshow:"<?php echo L('input_type_name')?>",onfocus:"<?php echo L('input_type_name')?>",oncorrect:"<?php echo L('true')?>"}).inputValidator({min:1,onerror:"<?php echo L('input_type_name')?>"});
    $('#type_path_1').formValidator({tipid:"typeTip",onshow:"<?php echo L('input_type_path')?>",onfocus:"<?php echo L('input_type_path')?>",oncorrect:"<?php echo L('true')?>"}).inputValidator({min:2,onerror:"<?php echo L('input_type_path')?>"}).regexValidator({regexp:"^\\w*$", onerror:"<?php echo L('error')?>"});
});
$("input:radio[name='special[ishtml]']").click(function (){
    if($("input:radio[name='special[ishtml]']:checked").val()==0) {
        $("#dr_row_filename").hide();
    } else if($("input:radio[name='special[ishtml]']:checked").val()==1) {
        $("#dr_row_filename").show();
    }
});
</script>