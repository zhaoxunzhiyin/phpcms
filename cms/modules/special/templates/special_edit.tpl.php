...
<form action="?m=special&c=special&a=edit&specialid=<?php echo $this->input->get('specialid')?>" class="form-horizontal" method="post" name="myform" id="myform">
    ...
    <div class="portlet-body form">
        ...
        <div class="portlet-body form myfooter">
            <div class="form-actions text-center">
                <button type="button" onclick="dr_ajax_submit('?m=special&c=special&a=edit&specialid=<?php echo $this->input->get('specialid')?>&page='+$('#dr_page').val(), 'myform', '2000')" class="btn green"> <i class="fa fa-save"></i> <?php echo L('submit')?></button>
            </div>
        </div>
    </div>
</div>
