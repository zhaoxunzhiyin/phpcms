        ...
        <div class="tab-content">
            <div class="tab-pane<?php if ($page==0) {?> active<?php }?>" id="tab_0">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group" id="dr_row_filename" style="display:<?php if($info['ishtml']) {?> <?php } else {?>none<?php }?>;">
                                ...
                                <table class="table table-nomargin table-bordered table-striped table-bordered table-advance">
                                    ...
                                    <tbody id="dr_type_body">
                                        ...
                                        <tr id="dr_ftable_type_row_<?php echo $k;?>">
                                            <td id="dr_row_type_name_<?php echo $k?>"><?php echo $t['typeid']?><input type="hidden" name="type[<?php echo $k?>][typeid]" value="<?php echo $t['typeid']?>"></td>
                                            <td id="dr_row_type_path_<?php echo $k?>"><input type="text" class="form-control" id="type_name_<?php echo $k?>" name="type[<?php echo $k?>][name]" value="<?php echo new_html_special_chars($t['name'])?>" onblur="topinyin('<?php echo WEB_PATH;?>api.php?op=pinyin','type_name_<?php echo $k?>','type_path_<?php echo $k?>',12);"></td>
                                            <td><input type="text" class="form-control" id="type_path_<?php echo $k?>" name="type[<?php echo $k?>][typedir]" value="<?php echo $t['typedir']?>"></td>
