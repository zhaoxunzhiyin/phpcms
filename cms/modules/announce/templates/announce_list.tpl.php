...
?>   
	...
	<td align="center">
	<?php if ($this->input->get('s')==1) {?><a class="btn btn-xs blue" href="<?php echo APP_PATH;?>index.php?m=announce&c=index&a=show&aid=<?php echo $announce['aid']?>" title="<?php echo L('preview')?>"  target="_blank"><?php echo L('index')?></a><?php }?> 
