...
$LANG['updatetime_check'] = 'Update the time field check status';
$LANG['check_not_default'] = 'The default is not checked';
$LANG['check_default'] = 'Check the default';
...
$LANG['index_create_close'] = 'First generation functions has been closed!';
...
$LANG['not_exists_copy'] = 'The copy function of module is disabled.';
...
$LANG['issystem_field_tips'] = 'The main table field can be used for list looping or searching; Attached table can only be used for content page display';
$LANG['yes'] = 'Yes';
$LANG['no'] = 'No';
$LANG['fieldname'] = 'Field name';
...
$LANG['basic_field'] = 'Display position';
$LANG['the_default'] = 'The default';
$LANG['right_field'] = 'On the right side';
$LANG['basic_field_tips'] = 'This function only support module content field use, select the "right" field is displayed in the right hand side.';
...
$LANG['copy_to_category'] = 'Copy to other columns';
...
$LANG['group_not_allowsearch'] = 'Group members search is prohibited.';
