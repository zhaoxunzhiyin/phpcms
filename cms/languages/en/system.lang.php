...
$LANG['to_success'] = 'To be successful！';
$LANG['number'] = 'Number';
$LANG['display'] = 'Display';
$LANG['hidden'] = 'Hidden';
$LANG['refresh_menu'] = 'To initialize the menu';
$LANG['confirm_refresh_menu'] = 'Make sure to initialize the menu?';
$LANG['refresh_menu_ok'] = 'Initialize the menu is successful, please press F5 to refresh the entire page';
$LANG['open_close'] = 'Expand or fold all of them';
...
$LANG['restore'] = 'Are you sure you want to restore『 {message} 』?';
$LANG['ok'] = 'Yes';
$LANG['clear'] = 'Clear';
$LANG['pass'] = 'Approval';
$LANG['unpass'] = 'Pending';
...
$LANG['module_not_exists'] = 'The module [{module}] is not installed or disabled';
$LANG['part_cache_success'] = 'Updating cache files';
$LANG['update_all_cache'] = 'Please update the site-wide cache before operation';
...
$LANG['ajax_tip'] = 'Please start with ajax: or ajax_ by passing AJAX. Also, please write in ajax_edit/ajax_delete only if modifying or deleting record operation';
...
$LANG['att_upload_num'] = 'Several restricted to a single upload file {file_num} a';
...
$LANG['hash_check_false'] = '[hash]Data validation timed out, please try again';
$LANG['point'] = 'Points';
$LANG['money'] = 'Yuan';
...
$LANG['city'] = 'City';
$LANG['fields'] = 'Field';
$LANG['site_field_manage'] = 'Site field manager';
$LANG['category_field_manage'] = 'Category field manager';
$LANG['page_field_manage'] = 'Page field manager';
$LANG['config_add'] = 'Property settings';
$LANG['unified_settings'] = 'Unified settings';
$LANG['in_recycle'] = 'Into the recycle bin';
$LANG['empty_recycle'] = 'Empty';
$LANG['recycle'] = 'Recycle';
$LANG['thorough'] = 'Thorough';
...
$LANG['select_file'] = 'Select the file！';
$LANG['browse'] = 'Browse';
$LANG['open'] = 'Open';
$LANG['close'] = 'Close';
$LANG['confirm_delete'] = 'Are you sure you want to remve it?';
$LANG['category_page'] = 'Single page';
$LANG['create_all'] = 'Generate All';
$LANG['public_error_log'] = 'Error Log';
$LANG['public_email_log'] = 'Email Log';
$LANG['setting_keyword_enable'] = 'Keyword extraction API';
$LANG['safe'] = 'Account security';
