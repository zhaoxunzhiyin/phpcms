...
$LANG['setting_confound'] = '防采集串混淆';
$LANG['setting_confound_desc'] = '一行一个，如果你要启用字符串混淆来防采集，请在模板加上 rndstring 函数，如：{rndstring($content)}。';
$LANG['setting_jump'] = '外链跳转';
$LANG['setting_whiteList'] = '域名白名单';
$LANG['setting_whiteList_desc'] = '域名一行一个，不需要加http前缀，顶级域名会匹配所有子域名，请在模板加上 dr_url_jump 函数，如：{dr_url_jump($content)}。';
$LANG['setting_default'] = '默认';
$LANG['setting_baidu'] = '百度';
$LANG['setting_xunfei'] = '讯飞';
$LANG['setting_qcnum'] = '分词数量';
$LANG['setting_qcnum_desc'] = '分词数量，为0时关闭分词功能';
...
$LANG['setting_keyword_test'] = '测试标题分词';
$LANG['setting_keyword_word'] = '测试分词结果';
$LANG['setting_keyword_participle'] = '测试分词';
$LANG['setting_bdmap_api'] = '百度地图Api-AK';
...
$LANG['setting_site_theme'] = '风格模式';
$LANG['setting_website_resources'] = '本站资源';
$LANG['setting_remote_address'] = '远程地址';
$LANG['setting_js_path'] = 'JS路径';
$LANG['setting_css_path'] = 'CSS路径';
$LANG['setting_img_path'] = '图片路径';
$LANG['setting_mobile_js_path'] = '手机JS路径';
$LANG['setting_mobile_css_path'] = '手机CSS路径';
$LANG['setting_mobile_img_path'] = '手机图片路径';
$LANG['setting_timezone'] = '网站时区';
$LANG['setting_timezone_desc'] = '例如中国地区选择“GMT +08:00”表示东八区';
$LANG['setting_time_format'] = '时间格式';
$LANG['setting_time_format_desc'] = '网站时间显示格式与date函数一致，默认Y-m-d H:i:s';
$LANG['setting_time'] = '当前时间';
...
$LANG['setting_admin_pagesize'] = '后台数据分页条数';
$LANG['setting_admin_pagesize_desc'] = '例如文章每页显示的数量控制';
$LANG['setting_admin_founders'] = '网站创始人ID';
$LANG['setting_admin_founders_desc'] = '网站创始人ID，多个ID逗号“,”分隔';

$LANG['setting_admin_debug'] = '调试器';
$LANG['setting_debug_desc'] = '你已经在index.php中开启了开发者模式，调试器已被强制开启';
$LANG['setting_admin_debug_desc'] = '用于后台启用DebugBar工具查看程序和SQL执行详情';
$LANG['setting_admin_log'] = '启用后台管理操作日志';
$LANG['setting_go_404'] = '跳转404页面';
$LANG['setting_go_404_desc'] = '开启后，404页面时直接跳转到404.html，不在当前url中显示404页面';
$LANG['setting_address_mode'] = '地址匹配模式';
$LANG['setting_unique_address'] = '唯一地址';
$LANG['setting_free_parameter'] = '自由参数';
$LANG['setting_index_address_mode_desc'] = '你已经在index.php中开启了禁止301跳转';
$LANG['setting_address_mode_desc'] = '唯一模式针对首页、栏目页、内容页等自己加入参数时将301跳转到本身的地址上';
$LANG['setting_address_rule'] = '地址唯一规则';
$LANG['setting_fuzzy_matching'] = '模糊匹配';
$LANG['setting_accurate_matching'] = '精确匹配';
$LANG['setting_address_rule_desc'] = '例如地址是abc/1.html，在地址前后加任意参数时，精确匹配模式下会404，模糊匹配模式下会正常识别';
$LANG['setting_csrf'] = 'CSRF跨站验证';
$LANG['strict_mode'] = '严格模式';
$LANG['loose_pattern'] = '宽松模式';
$LANG['setting_csrf_desc'] = '防止CSRF跨站攻击，宽松模式时针对后台操作不进行验证';
$LANG['setting_csrf_time'] = 'CSRF验证有效期';
$LANG['every_time'] = '每次生成';
$LANG['generated_periodically'] = '定期生成';
$LANG['setting_csrf_time_desc'] = '是否在每次请求时重新生成CSRF令牌';
...
$LANG['setting_letters'] = '纯字母';
$LANG['setting_character'] = '自定义字符集';
$LANG['setting_admin_code_len'] = '后台验证码位数';
$LANG['setting_noe_code_len'] = '验证码位数不能小于2位或超过8位';
$LANG['setting_code_position'] = '位';
$LANG['setting_voice_default'] = '默认语音';
$LANG['setting_voice_girl'] = '女生';
$LANG['setting_voice_boy'] = '男生';
$LANG['setting_pwd_safe'] = '密码安全应用范围';
$LANG['setting_login_safe'] = '登录安全应用范围';
$LANG['setting_safe'] = '账户安全应用范围';
$LANG['setting_admin'] = '后台';
$LANG['setting_member'] = '用户中心';
$LANG['setting_safe_desc'] = '选择以下配置适用的范围';
$LANG['pwd_is_edit'] = '是否定期强制修改密码';
$LANG['pwd_day_edit'] = '强制修改密码周期';
$LANG['login_password_mode'] = '后台登录密码加密传输模式';
$LANG['login_password_mode_desc'] = '当前php环境不支持openssl_decrypt，无法使用AES模式';
$LANG['setting_admin_mobile_login'] = '后台手机验证码登录';
$LANG['setting_admin_mobile_login_desc'] = '登录后台时使用手机验证码登录，需要提前给账号设置手机号码并设置短信发送功能';
$LANG['setting_admin_mobile_check'] = '后台账号登录后手机验证';
$LANG['setting_admin_mobile_check_desc'] = '用账号登录后台，是否使用手机验证码二次验证登录，需要提前给账号设置手机号码并设置短信发送功能';
$LANG['pwd_day'] = '天';
$LANG['pwd_is_login_edit'] = '首次强制修改密码';
$LANG['pwd_is_login_edit_desc'] = '首次登录是否强制修改密码';
$LANG['pwd_is_rlogin_edit'] = '重置密码后强制修改密码';
$LANG['pwd_is_rlogin_edit_desc'] = '重置密码后，首次登录是否强制修改密码';
$LANG['setting_maxloginfailedtimes'] = '后台登录时密码最大错误次数';
$LANG['login_ci'] = '次';
$LANG['setting_maxloginfailedtimes_desc'] = '后台登录失败N次后，系统将锁定登录，0表示不限制';
$LANG['setting_time_limit'] = '后台登录时密码错误校验周期';
$LANG['minutes'] = '分钟';
$LANG['setting_time_limit_desc'] = '单位分钟，后台登录失败锁定后在x分钟内禁止登录，默认10分钟';
$LANG['login_is_option'] = '长时间未操作自动退出';
$LANG['login_is_option_desc'] = '登录后长时间未操作自动退出账号';
$LANG['login_exit_time'] = '自动退出周期';
$LANG['login_city'] = '同一账号在异地进行登录';
$LANG['yes_city'] = '允许异地';
$LANG['no_city'] = '禁止异地';
$LANG['login_city_desc'] = '通过IP判断登录，IP不一致时强制退出其他地区的账号';
$LANG['login_llq'] = '同一账号在其他设备进行登录';
$LANG['yes_llq'] = '允许其他设备';
$LANG['no_llq'] = '禁止其他设备';
$LANG['login_llq_desc'] = '通过设备或浏览器判断登录，设备不一致时强制退出其他设备的账号';
$LANG['long_time_lock'] = '长期未登录锁定';
$LANG['long_time_lock_desc'] = '单位天，0表示不限制，当N天没登录的情况下再次登录时先锁定账号';
$LANG['setting_keys'] = '系统安全密钥';
$LANG['setting_keys_desc'] = '密钥建议定期更换，更换密钥之后本次登录将会自动退出';
$LANG['setting_cookie'] = 'Cookie前缀';
$LANG['setting_cookie_desc'] = 'Cookie前缀建议定期更换，更换之后本次登录将会自动退出';
$LANG['setting_regenerate'] = '重新生成';
...
$LANG['test_email_to'] = '当前邮件设置测试没有设置邮箱';
$LANG['test_email_succ_to'] = '已发送至邮箱：{mail_to}，并不代表已发送成功';
...
$LANG['lock'] = '锁定';
$LANG['unlock'] = '解锁';
$LANG['founder_cannot_locked'] = '创始人不能被锁定';
...
$LANG['phone_already_exists'] = '该手机已经存在';
...
$LANG['batch_utf8mb4'] = '转换为utf8mb4编码';
...
$LANG['database_backup_not_exist'] = '数据库备份文件不存在';
...
$LANG['description'] = '介绍';
$LANG['domain'] = '绑定域名';
$LANG['mobile_category_domain'] = '手机绑定域名';
...
$LANG['mobile_html_category'] = '手机栏目生成Html';
$LANG['mobile_html_show'] = '手机内容页生成Html';
...
$LANG['html_home'] = '首页静态';
$LANG['site_statu'] = '网站状态';
$LANG['site_close_msg'] = '网站关闭理由';
$LANG['site_close_desc'] = '当关闭网站时，除管理员之外的用户将无法访问（静态页面除外）';
$LANG['access_mode'] = '访问模式';
$LANG['close_mode'] = '关闭手机端（自适应模式）';
$LANG['domain_mode'] = '域名模式';
$LANG['directory_mode'] = '目录模式';
$LANG['self_adaption'] = '自适应';
$LANG['self_adaption_desc'] = '自适应模式表示无手机域名或者关闭手机模式';
$LANG['mobile_domain'] = '手机域名';
$LANG['mobile_dirname'] = '手机目录';
$LANG['mobile_dirname_desc'] = '格式：mobile，不能包含/符号';
$LANG['build_directory'] = '生成目录';
$LANG['mobile_auto'] = '自动识别';
$LANG['mobile_auto_desc'] = '未绑定移动端域名时自动识别移动端终端模板；绑定移动端域名时自动跳转到移动端域名上';
$LANG['template_tip'] = '模板提示';
$LANG['template_tip_desc'] = '没有检测到你的手机端模板，将无法使用单独的手机界面';
$LANG['html_mobile'] = 'URL规则';
$LANG['html_mobile_url'] = '与PC端URL同步';
$LANG['dynamic_address'] = '动态地址';
$LANG['html_mobile_desc'] = '与PC端URL同步表示移动端与PC端一致；当PC端执行生成静态命令时，移动端也会生成相应的静态文件；动态地址表示移动端动态地址';
$LANG['mobile_not_pad'] = '将平板端排除';
$LANG['mobile_not_pad_desc'] = '平板端访问时不会识别为移动端界面，平板将访问PC界面';
$LANG['mobile_template'] = '模板路径';
$LANG['mobile_template_style'] = '/模板目录/{style}/mobile/content/index.html';
...
$LANG['ueditor_music_max_size'] = '允许上传音频大小';
$LANG['ueditor_music_allow_ext'] = '允许上传音频类型';
...
$LANG['ueditor_musicmanager_max_size'] = '每次列出音频数量';
$LANG['ueditor_musicmanager_allow_ext'] = '列出音频类型';
...
$LANG['site_att_text_font_desc'] = '自定义水印字体文件.caches/watermark/***.ttf';
...
$LANG['site_att_watermark_img_desc'] = '自定义图片水印文件.caches/watermark/***.png';
...
$LANG['complete_parent_path'] = '包含父级子级层次的目录';
$LANG['representing_search_parameters'] = '表示搜索参数';
...
$LANG['install'] = '安装';
$LANG['install_desc'] = '当您在使用第三方应用程序时，官方不保证它的合法性、安全性、完整性、真实性或品质等，请用户自行判断是否安装并承担所有风险。';
...
$LANG['clear_logs'] = '清理全部系统日志、邮件日志、错误日志、慢查询日志等';
$LANG['remote_attachment'] = '远程附件';
$LANG['update_attachment'] = '附件地址未更新时，更新附件缓存';
$LANG['update_thumb'] = '手动清理缩略图文件（如果生成过静态页面，请慎用）';
$LANG['update_rewrite_routes'] = '更新自定义路由缓存';
$LANG['update'] = '更新';
$LANG['cache_file_success'] = '缓存完成';
$LANG['site_cache_completed'] = '全站缓存更新完成';
...
$LANG['modelid_edit_tips'] = ' 当该栏目下数据为 0 时，可更换模型';
