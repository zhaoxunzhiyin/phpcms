...
$LANG['html_mobile'] = '生成静态';
$LANG['html_mobile_desc'] = '当PC端执行生成静态命令时，移动端也会生成相应的静态文件；关闭表示移动端不生成静态文件';
...
$LANG['site_att_text_font_desc'] = '自定义水印字体文件./statics/images/water/font/***.ttf';
...
$LANG['site_att_watermark_img_desc'] = '自定义图片水印文件./statics/images/water/***.png';
