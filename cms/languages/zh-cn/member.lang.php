...
$LANG['setting_maxloginfailedtimes'] = '最大登录失败次数';
$LANG['login_ci'] = '次';
$LANG['setting_maxloginfailedtimes_desc'] = '登录失败N次后，系统将锁定登录，0表示不限制';
$LANG['setting_time_limit'] = '登录失败时限';
$LANG['minutes'] = '分钟';
$LANG['setting_time_limit_desc'] = '单位分钟，登录失败锁定后在x分钟内禁止登录，默认10分钟';
...
$LANG['filed_nickname_need'] = '请输入显示名称';
...
$LANG['filed_nickname'] = '显示名称';
$LANG['exaple_title'] = '例如：文章标题';
$LANG['field_cue'] = '字段提示';
$LANG['nickname_alert'] = '显示在显示名称下方作为表单输入提示';
...
$LANG['sina_login_notice'] = '使用新浪微博连接登录CMS,将精彩内容分享到新浪微博。';
$LANG['qq_login_notice'] = '使用腾讯微博连接登录CMS,将精彩内容分享到腾讯微博。';
$LANG['snda_login_notice'] = '使用用盛大连接登录CMS,轻松使用盛大所有服务。';
