...
$LANG['description'] = '描述';
$LANG['updatetime_check'] = '更新时间字段勾选状态';
$LANG['check_not_default'] = '默认不勾选';
$LANG['check_default'] = '默认勾选';
...
$LANG['index_create_close'] = '首页生成功能已经关闭!';
...
$LANG['not_exists_copy'] = '此模块还没有开启复制功能！';
...
$LANG['issystem_field_tips'] = '主表字段可用于列表循环或者搜索；附表只能用于内容页显示';
$LANG['yes'] = '是';
$LANG['no'] = '否';
$LANG['fieldname'] = '字段名称';
...
$LANG['unique'] = '值唯一';
$LANG['basic_field'] = '显示位置';
$LANG['the_default'] = '默认';
$LANG['right_field'] = '右侧';
$LANG['basic_field_tips'] = '此功能仅支持模块内容字段使用，选择“右侧”时字段显示在右侧部分';
...
$LANG['group_not_allowsearch'] = '会员组禁止搜索';
