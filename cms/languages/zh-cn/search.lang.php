...
$LANG['re_index_note'] = '重建索引将会清空原有的所有的索引内容';
$LANG['re_index_updates'] = '每轮更新';
$LANG['re_index_number'] = '分词数量';
$LANG['tiao'] = '条';
...
$LANG['pagination_count'] = '分页数量';
$LANG['pagination_count_desc'] = '每页显示多少条内容，默认10';
