...
$checkcode->show_code();
pc_base::load_sys_class('cache')->set_auth_data('web-captcha-'.md5(pc_base::load_sys_class('input')->ip_address().pc_base::load_sys_class('input')->get_user_agent()), $checkcode->get_code(), 1);
exit;