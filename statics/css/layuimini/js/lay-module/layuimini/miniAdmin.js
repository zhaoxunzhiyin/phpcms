layui.define(["jquery", "miniMenu", "element","miniTab", "miniTheme"], function (exports) {
    ...
    var miniAdmin = {
        ...
        renderHome: function (data) {
            ...
            $('#layuiminiHomeTabId').html('<span class="layuimini-tab-fa fa fa-home"></span><span class="disable-close">' + data.title + '</span><i class="layui-icon layui-unselect layui-tab-close">ဆ</i>');
