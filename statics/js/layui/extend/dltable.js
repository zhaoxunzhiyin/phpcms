layui.define(['laytpl', 'laypage', 'layer', 'form'], function(exports){
    ...
    var $ = layui.$
        ...
        ,TREE_ID='treeId',TREE_MANAGE='treeManage',TREE_UPID='treeUpId',TREE_SHOW_NAME='treeShowName',TREE_KEY_MAP='tree_key_map'
        //thead区域模板
        ...
        var that = this
            ...
            ,render = function(){ //后续性能提升的重点
                ...
                layui.each(data, function(i1, obj){
					...
					tds_fixed=['<td data-field="'+ options[TREE_ID] + '"><div class="layui-table-cell laytable-cell-'+ options.index + '-'+ options[TREE_ID] + '">'+ obj[options[TREE_ID]] + '</div></td>'];
					tds_fixed_r=['<td data-field="'+ options[TREE_MANAGE] + '"><div class="layui-table-cell laytable-cell-'+ options.index + '-'+ options[TREE_MANAGE] + '">'+ obj[options[TREE_MANAGE]] + '</div></td>'];
