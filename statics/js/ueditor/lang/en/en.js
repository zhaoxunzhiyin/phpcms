...
UE.I18N['en'] = {
    ...
    'music':{
        'static':{
            'lang_tab_insertA':"Audio",
            'lang_tab_searchA':"Search",
            'lang_tab_uploadA':"Upload",
            'lang_tab_online':"Manager",
            'lang_music_url':" URL ",
            'lang_music_size':"Audio Size",
            'lang_musicW':"Width",
            'lang_musicH':"Height",
            'lang_alignment':"Alignment",
            'lang_musicLoading':"Loading...",
            'musicSearchTxt':{'value':"Enter the search keyword!"},
            'musicType':{'options':["All", "Hot", "Entertainment", "Funny", "Sports", "Science", "variety"]},
            'musicSearchBtn':{'value':"Search in Baidu"},
            'musicSearchReset':{'value':"Clear result"},
        ...
        'floatDefault':"Default",
        'block':"Display in block",
        'urlError':"The music url format may be wrong!",
        'loading':" &nbsp;The music is loading, please wait…",
        'clickToSelect':"Click to select",
        'goToSource':'Visit source music ',
        'noAudio':" &nbsp; &nbsp;Sorry,can't find the music,please try again!",
    ...
    snapscreen:{
        'static':{
            ...
            lang_errorMsg:"The icon function has been disabled, please use the capture screenshot software, and then paste into the editor!"
        }
    },
    spechars:{
        'static':{},
