...
(function () {
    ...
    UploadFile.prototype = {
        ...
        initUploader: function () {
            ...
            // WebUploader实例
                uploader,
                actionUrl = editor.getActionUrl(editor.getOpt('wordActionName')),
                wordMaxSize = editor.getOpt('wordMaxSize'),
                acceptExtensions = ['.docx'].join('').replace(/\./g, ',').replace(/^[,]/, '');

            if (!WebUploader.Uploader.support()) {
                $('#filePickerReady').after($('<div>').html(lang.errorNotSupport)).hide();
                return;
            } else if (!editor.getOpt('wordActionName')) {
            ...
            uploader = _this.uploader = WebUploader.create({
                ...
                server: actionUrl,
                fileVal: editor.getOpt('wordFieldName'),
                duplicate: true,
                threads: 1,
                fileSingleSizeLimit: wordMaxSize,
                compress: false
            });
            uploader.addButton({
                id: '#filePickerBlock'
