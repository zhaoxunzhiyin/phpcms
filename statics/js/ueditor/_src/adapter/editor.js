        ...
        editor.addListener('selectionchange', function (t, causeByUi) {
          ...
          if (img && img.tagName == 'IMG') {
            ...
            if (img.getAttribute("anchorname")) {
              ...
              if (editor.options.anchorDqEnabled == true) {
            ...
            if ((editor.options.imageDqEnabled == true && dialogName == 'insertimageDialog') || (editor.options.videoDqEnabled == true && dialogName == 'insertvideoDialog') || (editor.options.musicDqEnabled == true && dialogName == 'musicDialog')) {
              eval('$EDITORUI[\"'+popup.getUid()+'\"]._onImgEditButtonClick(\''+dialogName+'\')');
              return;
            }
