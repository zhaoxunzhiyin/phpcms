var calendar = (function (exports) {
  ...
  var calendar = {
    ...
    newdate: function newdate(yPara, mPara, dPara) {
      ...
      $('#nowtime').html('\u5F53\u524D\u65F6\u95F4\uFF1A' + solarDate + '\u3010\u519C\u5386'+ (isLeap ? '\u95F0' : '') + this.toChinaMonth(month) + this.toChinaDay(day) +'\u3011' + this.datefilter(hour) + ':' + this.datefilter(minute) + ':' + this.datefilter(second) + ' ' + '\u661F\u671F' + cWeek);
      $('#main_hello').html('\uFF0C'+timevalue+'\u597D\uFF01');
