...
function colorpicker(showid,fun) {
	...
	colorTable='<div style="position:relative;width:253px; height:176px;z-index: 9999;"><a href="javascript:;" onclick="closeBox();" class="close-own">X</a><table width=253 border="0" cellspacing="0" cellpadding="0" style="border:1px #000 solid;border-bottom:none;border-collapse: collapse" bordercolor="000000">'
